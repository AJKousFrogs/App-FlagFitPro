...
async function executeSQLViaManagementAPI(sql) {
  ...
  try {
    ...
    // Management API might not be available, fall back to instructions
    throw error;
  }
}
...
async function main() {
  ...
  try {
    ...
    console.log();
    console.log(`1. Go to: https://supabase.com/dashboard/project/${TARGET_PROJECT_REF}/sql`);
    console.log("2. Click 'New query'");
    console.log(`3. Copy/paste content from: ${CONSOLIDATED_SQL_FILE}`);
    console.log("4. Click 'Run'");
    console.log();
    console.log("OR use psql:");
    console.log(`   psql "postgresql://postgres.${TARGET_PROJECT_REF}:${TARGET_SERVICE_KEY}@aws-0-us-west-1.pooler.supabase.com:5432/postgres" -f ${CONSOLIDATED_SQL_FILE}`);
    console.log();
