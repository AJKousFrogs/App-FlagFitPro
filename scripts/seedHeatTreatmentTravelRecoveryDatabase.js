  ...
  try {
    ...
    const saunaResearch = [
      {
        ...
        study_title: 'Effects of repeated use of post-exercise infrared sauna on neuromuscular performance and muscle hypertrophy',
        authors: ['Rodriguez-Giustiniani', 'P.', 'Rosenblat', 'M.A.', 'Stein', 'K.R.'],
      ...
      },
      {
        ...
        study_title: 'The effect of post-exercise heat exposure (passive heat acclimation) on endurance exercise performance: a systematic review and meta-analysis',
      ...
      },
      {
        ...
        study_title: 'Effects of regular sauna bathing in conjunction with exercise on cardiovascular function: a multi-arm, randomized controlled trial',
    ...
    const compressionBootsResearch = [
      {
        ...
        study_title: 'Effects of intermittent pneumatic compression as a recovery method after exercise: A comprehensive review',
      ...
      },
      {
        ...
        study_title: 'The Effects of Intermittent Pneumatic Compression on the Reduction of Exercise-Induced Muscle Damage in Endurance Athletes: A Critically Appraised Topic',
    ...
    const compressionGarmentsResearch = [
      ...
      },
      {
        ...
        study_title: 'Compression stockings for preventing deep vein thrombosis in airline passengers (Updated Cochrane Review)',
    ...
    const travelFatigueResearch = [
      {
        ...
        study_title: 'Managing Travel Fatigue and Jet Lag in Athletes: A Review and Consensus Statement',
      ...
      },
      {
        ...
        study_title: 'The impact of long haul travel on the sleep of elite athletes',
        ...
        citation_count: 12,
        meta_data: {
          'sleep_parameters_affected': ['time_in_bed', 'total_sleep_time', 'sleep_efficiency'],
    ...
    console.log(`✅ Seeded ${allResearch.length} heat treatment & travel recovery studies`);

  } catch (error) {
    console.error('❌ Error seeding heat treatment & travel recovery database:', error);
    throw error;
  } finally {
    client.release();
  }
...
if (import.meta.url === `file://${process.argv[1]}`) {
  seedHeatTreatmentTravelRecoveryDatabase()
    .then(() => {
      console.log('🎉 Heat treatment & travel recovery database seeding completed!');
      process.exit(0);
    })
    .catch((error) => {
