...
const isometricExercises = [
  {
    ...
    description: "Isometric squat position against a wall to develop quadriceps and glute strength",
    category: "lower_body",
    ...
    setup_instructions: "Stand with back against wall, feet shoulder-width apart, slide down until thighs are parallel to ground",
  ...
  {
    name: "Plank Hold",
    description: "Isometric core exercise to develop abdominal and back stability",
    category: "core",
    ...
    difficulty_level: "beginner",
    equipment_required: [],
    setup_instructions: "Hold push-up position with forearms on ground, body straight from head to heels",
  ...
  },
  {
    ...
    description: "Isometric hold at the top of push-up position to develop chest and tricep strength",
    category: "upper_body",
    ...
    equipment_required: [],
    setup_instructions: "Hold top position of push-up with arms extended, body straight",
    safety_notes: "Maintain straight body alignment, avoid elbow hyperextension",
  ...
  },
  {
    ...
    description: "Isometric hold at the top of deadlift position to develop posterior chain strength",
    category: "full_body",
    ...
    setup_instructions: "Hold barbell at hip level with straight back and engaged core",
  ...
  },
  {
    ...
    description: "Isometric hold at the top of pull-up position to develop back and bicep strength",
    category: "upper_body",
  ...
  },
  {
    ...
    description: "Isometric hold in forward lunge position to develop single-leg stability",
    category: "lower_body",
    ...
    difficulty_level: "intermediate",
    equipment_required: [],
    setup_instructions: "Hold forward lunge position with front knee at 90 degrees",
  ...
  },
  {
    ...
    difficulty_level: "intermediate",
    equipment_required: [],
    setup_instructions: "Hold side plank position with body straight from head to feet",
  ...
  },
  {
    ...
    description: "Isometric hold with weight overhead to develop shoulder stability",
    category: "upper_body",
...
const researchArticles = [
  {
    ...
    lifting_synergy_evidence: "Strong evidence for pre-activation effects on dynamic performance",
    optimal_timing: "3-5 minutes before dynamic training",
    dosage_recommendations: "3-5 sets of 3-5 second maximal contractions"
  },
  {
    title: "The acute effects of heavy-load isometric contractions on subsequent dynamic performance",
  ...
  },
  {
    ...
    authors: ["Oranchuk, D. J.", "Robinson, T. L.", "Switaj, Z. J.", "Burr, J. F."],
    journal: "Sports Medicine",
    ...
    dosage_recommendations: "Multiple sets of 10-30 second submaximal contractions"
  }
];
...
const trainingPrograms = [
  {
    ...
    description: "8-week program integrating isometrics with traditional lifting for flag football performance",
    ...
    research_basis: "Based on post-activation potentiation research and sport-specific adaptations",
    expected_outcomes: [
  ...
  },
  {
    ...
    description: "6-week program targeting throwing mechanics and shoulder stability",
    program_type: "power",
    ...
    total_sessions: 12,
    lifting_integration_type: "pre-activation",
    isometrics_to_lifting_ratio: 0.30,
    research_basis: "Based on throwing mechanics research and shoulder stability studies",
    expected_outcomes: [
      "8-12% improvement in throwing distance",
    ...
    phases: [
      ...
      },
      {
        ...
        isometrics_intensity: "70-80% MVC",
        isometrics_duration: "10-15 seconds",
        exercises: ["Overhead Press Hold", "Push-Up Hold", "Core stability holds"]
      },
      {
        phase: 3,
        weeks: "5-6",
...
async function seedIsometricsDatabase() {
  try {
    ...
    for (const exercise of isometricExercises) {
      ...
      const values = [
        exercise.name, exercise.description, exercise.category, exercise.muscle_groups,
        exercise.protocol_type, exercise.recommended_duration_seconds, exercise.recommended_sets,
        exercise.recommended_reps, exercise.rest_period_seconds, exercise.intensity_percentage,
        exercise.difficulty_level, exercise.equipment_required, exercise.setup_instructions,
        exercise.safety_notes, exercise.research_studies, exercise.evidence_level,
        exercise.lifting_synergy_exercises, exercise.pre_lifting_recommendation,
    ...
    for (const article of researchArticles) {
      ...
      const values = [
        article.title, article.authors, article.journal, article.publication_year,
        article.doi, article.research_area, article.study_type, article.population_type,
        article.key_findings, article.isometrics_protocols, article.lifting_integration_findings,
        article.evidence_level, article.sample_size, article.study_duration_weeks,
        article.practical_recommendations, article.lifting_synergy_evidence,
        article.optimal_timing, article.dosage_recommendations
      ];
    ...
    for (const program of trainingPrograms) {
      ...
      const values = [
        program.name, program.description, program.program_type, program.target_position,
        program.skill_level, program.age_group, program.duration_weeks, program.sessions_per_week,
        program.total_sessions, program.lifting_integration_type, program.isometrics_to_lifting_ratio,
        program.research_basis, program.expected_outcomes, program.contraindications,
