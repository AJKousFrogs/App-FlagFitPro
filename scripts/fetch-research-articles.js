...
function extractTags(article, category) {
  ...
  if (text.includes("ankle")) {
    tags.push("ankle_sprain");
  }
  if (text.includes("hamstring")) {
    tags.push("hamstring_strain");
  }
  if (text.includes("acl")) {
    tags.push("acl_injury");
  }
  if (text.includes("shoulder")) {
    tags.push("shoulder_injury");
  }
...
function determineStudyType(abstract) {
  ...
  if (lower.includes("systematic review")) {
    return "systematic_review";
  }
  if (lower.includes("randomized controlled trial") || lower.includes("rct")) {
    return "rct";
  }
  if (lower.includes("cohort study")) {
    return "cohort";
  }
  if (lower.includes("case-control")) {
    return "case_control";
  }
...
function determineEvidenceLevel(studyType, _citationCount) {
  ...
  if (studyType === "case_control") {
    return "B";
  }
  if (studyType === "case_study") {
    return "C";
  }
  if (studyType === "review") {
    return "C";
