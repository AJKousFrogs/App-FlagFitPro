...
try {
  ...
  try {
    ...
    console.warn(
      "⚠️  PostCSS not found. Install with: npm install --save-dev postcss-cli postcss",
    );
  }
  ...
  try {
    ...
    console.warn(
      "⚠️  esbuild not found. Install with: npm install --save-dev esbuild",
    );
  }

  console.log("\n📝 Note: This is a basic build script.");
  console.log(
    "   For full minification, install build tools and configure properly.\n",
  );
