  ...
  async seedCompleteWADAProhibitedList() {
    ...
    const prohibitedSubstances = [
      ...
      // S1 - Anabolic agents
      {
        ...
        detection_window_days: 30,
        common_sources: ['anabolic_steroids', 'testosterone_boosters', 'prohormones']
      },
      {
      ...
      },
      {
        ...
        flag_football_relevance: 'high',
        detection_window_days: 30,
        common_sources: ['research_compounds', 'online_supplements', 'bodybuilding_supplements']
      },
      ...
      // S2 - Peptide hormones, growth factors, related substances
      {
        ...
        common_sources: ['blood_doping', 'recombinant_epo', 'performance_clinics']
      },
      {
        ...
        common_sources: ['anti_aging_clinics', 'performance_clinics', 'online_sources']
      },
      {
      ...
      // S3 - Beta-2 agonists
      {
        ...
        exceptions: ['therapeutic_use_exemption_allowed', 'max_1600_mcg_per_day', 'max_800_mcg_per_12_hours']
      },
      {
      ...
      // S4 - Hormone and metabolic modulators
      {
        ...
        flag_football_relevance: 'moderate',
        detection_window_days: 14,
        common_sources: ['cancer_treatments', 'bodybuilding_supplements', 'online_pharmacies']
      },
      {
      ...
      // S5 - Diuretics and masking agents
      {
        ...
        flag_football_relevance: 'low',
        detection_window_days: 3,
        common_sources: ['prescription_medications', 'blood_pressure_treatments']
      },
      {
      ...
      // S6 - Stimulants
      {
        ...
        flag_football_relevance: 'moderate',
        detection_window_days: 3,
        common_sources: ['ADHD_medications', 'prescription_stimulants', 'recreational_drugs']
      },
      {
      ...
      },
      {
        ...
        common_sources: ['cold_medications', 'decongestants', 'weight_loss_supplements'],
      ...
      // S9 - Glucocorticoids
      {
        ...
        flag_football_relevance: 'low',
        detection_window_days: 2,
        common_sources: ['prescription_medications', 'anti_inflammatory_treatments'],
        exceptions: ['oral_rectal_iv_im_prohibited', 'topical_inhalation_allowed']
      },
      {
      ...
      // P1 - Beta-blockers
      {
        ...
        flag_football_relevance: 'low',
        detection_window_days: 2,
        common_sources: ['blood_pressure_medications', 'performance_anxiety_medications'],
        exceptions: ['therapeutic_use_exemption_allowed']
      },
      {
    ...
    for (const substance of prohibitedSubstances) {
      try {
        ...
        console.error(`Error inserting ${substance.substance_name}:`, error.message);
      }
    }
    
    console.log(`✅ Seeded ${prohibitedSubstances.length} WADA prohibited substances`);
  }
  ...
  async seedCommonMedications() {
    ...
    const commonMedications = [
      {
        ...
        usage_guidelines: 'Requires Therapeutic Use Exemption (TUE) for competition use. Max 1600mcg/day, 800mcg/12h.',
        compliance_notes: 'Asthma medication - allowed with TUE. Monitor usage and maintain TUE documentation.',
        risk_mitigation_strategies: ['obtain_tue', 'monitor_dosage', 'keep_medical_documentation']
      },
      {
        ...
        flag_football_safe: true,
        recommended_for_position: ['all_positions'],
        usage_guidelines: 'Requires TUE. Contains salmeterol (beta-2 agonist) - prohibited in competition without TUE.',
        compliance_notes: 'Combination asthma medication. Salmeterol component requires TUE for competition.',
        risk_mitigation_strategies: ['obtain_tue', 'consult_sports_physician', 'monitor_competition_use']
      },
      {
        ...
        flag_football_safe: true,
        recommended_for_position: ['all_positions'],
        usage_guidelines: 'Requires TUE for competition use. Same as Ventolin (salbutamol).',
      ...
      },
      {
        ...
        flag_football_safe: true,
        recommended_for_position: ['all_positions'],
        usage_guidelines: 'Non-sedating antihistamine - safe for competition use.',
      ...
      },
      {
        ...
        flag_football_safe: true,
        recommended_for_position: ['all_positions'],
        usage_guidelines: 'Anti-inflammatory pain reliever - safe for competition use.',
        compliance_notes: 'Pain medication - not prohibited by WADA.',
        risk_mitigation_strategies: ['no_restrictions', 'safe_for_competition']
      }
    ];
    ...
    for (const medication of commonMedications) {
      try {
        ...
        console.error(`Error inserting ${medication.supplement_name}:`, error.message);
      }
    }
