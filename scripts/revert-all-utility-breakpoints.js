...
const replacements = [
  ...
  {
    pattern: /@include respond-to\(xs\)/gi,
  ...
  {
    pattern: /@include respond-to\(xl\)/gi,
    replacement: "@media (max-width: 1280px)",
  },
  {
    pattern: /@include respond-to\(xxl\)/gi,
    replacement: "@media (max-width: 1536px)",
  },

  // respond-above (min-width)
  {
    pattern: /@include respond-above\(xs\)/gi,
  ...
  {
    pattern: /@include respond-above\(xl\)/gi,
    replacement: "@media (min-width: 1281px)",
  },
  {
    pattern: /@include respond-above\(xxl\)/gi,
    replacement: "@media (min-width: 1537px)",
  },
];
