...
class SupplementResearchSeederCorrected {
    ...
    const creatineStudies = [
      {
        ...
        sprint_performance_improvement: 8.5,
      ...
      },
      {
        ...
        sprint_performance_improvement: 6.8,
        muscle_mass_gain_kg: 3.2,
    ...
    const supplements = [
      {
        ...
        contraindications: ["kidney disease", "diabetes"],
        research_summary:
          "Extensive research supports creatine monohydrate for strength and power improvements",
        key_studies: [
      ...
      },
      {
        ...
        research_summary:
          "Strong evidence for beta-alanine in improving high-intensity exercise performance",
        key_studies: [
      ...
      },
      {
        ...
        research_summary:
          "Extensive research supports caffeine for improved exercise performance",
        key_studies: [
    ...
    for (const supplement of supplements) {
      try {
        ...
        await this.pool.query(query, [
          ...
          JSON.stringify(supplement.active_ingredients),
          supplement.serving_size,
          supplement.servings_per_container,
          supplement.evidence_level,
          supplement.safety_rating,
          supplement.banned_substance_risk,
          supplement.performance_benefits,
          supplement.recommended_timing,
          supplement.recommended_dosage,
          supplement.duration_of_use,
          supplement.drug_interactions,
          supplement.food_interactions,
          supplement.side_effects,
          supplement.contraindications,
          supplement.research_summary,
          supplement.key_studies,
          supplement.brand,
          supplement.cost_per_serving,
  ...
  async seedAthleteSupplementPlans() {
    ...
    const supplementResult = await this.pool.query(
      "SELECT id, name FROM supplements LIMIT 3",
    );
  ...
  async runAllSeeders() {
    console.log(
      "🚀 Starting Corrected Supplement Research Database Seeding...\n",
    );
...
export default SupplementResearchSeederCorrected;
