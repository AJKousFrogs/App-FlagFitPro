...
async function seedWeatherTrainingDatabase() {
  ...
  try {
    ...
    const predictionImpacts = [
      {
        ...
        optimal_training_windows: [
          ...
          "After storm passes completely",
        ],
        equipment_requirements: [
          "Lightning detection system",
          "Emergency communication",
        ],
        athlete_preparation_tips: [
          "Monitor weather updates",
          "Have indoor gear ready",
        ],
        coach_adaptation_strategies: [
          "Flexible scheduling",
          "Indoor practice plans ready",
        ],
      },
      {
        ...
        recommended_alternatives: [
          "Modified outdoor training",
          "Covered area drills",
        ],
        indoor_backup_options: [
          "Partial indoor training",
          "Skills work under cover",
        ],
        optimal_training_windows: [
          "Between showers",
          "Light steady rain periods",
        ],
    ...
    console.log(
      `✅ Seeded ${weatherConditions.length} weather conditions and ${predictionImpacts.length} prediction impacts`,
    );
  } catch (error) {
