...
async function runMigration(filePath) {
  ...
  try {
    ...
    if (error) {
      ...
      console.log(`⚠️  RPC method not available. This migration needs to be run via Supabase Dashboard SQL Editor.`);
...
async function main() {
  ...
  console.log('⚠️  Note: Supabase REST API cannot execute DDL statements (CREATE TABLE, etc.)');
