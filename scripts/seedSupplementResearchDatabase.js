    ...
    const ashwagandhaResearch = [
      {
        ...
        study_title: 'Effects of Ashwagandha (Withania somnifera) on Physical Performance: Systematic Review and Bayesian Meta-Analysis',
      ...
      },
      {
        ...
        study_title: 'The effect of Ashwagandha (Withania somnifera) on sports performance: a systematic review and meta-analysis',
    ...
    const rhodiolaResearch = [
      {
        ...
        study_title: 'Rhodiola rosea supplementation on sports performance: A systematic review of randomized controlled trials',
      ...
      },
      {
        ...
        study_title: 'Effects of Rhodiola Rosea Supplementation on Exercise and Sport: A Systematic Review',
    ...
    const creatineResearch = [
      {
        ...
        study_title: 'Effects of Creatine Supplementation and Resistance Training on Muscle Strength Gains in Adults <50 Years of Age: A Systematic Review and Meta-Analysis',
      ...
      },
      {
        ...
        study_title: 'Effects of Creatine Monohydrate on Endurance Performance in a Trained Population: A Systematic Review and Meta-Analysis',
    ...
    const caffeineResearch = [
      {
        ...
        study_title: 'Efficacy of caffeine on athletic performance: A systematic review and meta-analysis',
      ...
      },
      {
        ...
        study_title: 'Dose and timing effects of caffeine on subsequent sleep: a randomized clinical crossover trial',
    ...
    const betaAlanineResearch = [
      {
        ...
        study_title: 'Effect of Beta-Alanine Supplementation on Maximal Intensity Exercise in Trained Young Male Individuals: A Systematic Review and Meta-Analysis',
      ...
      },
      {
        ...
        study_title: 'Effects of Beta-Alanine Supplementation on Physical Performance in Aerobic-Anaerobic Transition Zones: A Systematic Review and Meta-Analysis',
        authors: ['Santana', 'J.O.', 'de Freitas', 'M.C.', 'Dos Santos', 'D.M.'],
