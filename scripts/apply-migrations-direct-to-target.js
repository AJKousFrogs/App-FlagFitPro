...
async function main() {
  ...
  console.log();
  console.log(
    "⚠️  The Supabase REST API doesn't support arbitrary SQL execution.",
  );
  console.log(
    "   To apply migrations, you need to use one of these methods:\n",
  );
  ...
  console.log(
    "💡 The MCP server is currently connected to a different project.",
  );
  console.log(
    "   To use MCP, you'd need to reconfigure it for grfjmnjpzvknmsxrwesx.\n",
  );
