...
async function seedEvidenceBasedResearchDatabase() {
  ...
  try {
    ...
    const recoveryResearch = [
      {
        domain: 'Recovery',
        subdomain: 'Sleep',
        study_title: 'Sleep and Athletic Performance: Impacts on Physical Performance, Mental Performance, Injury Risk and Recovery, and Mental Health',
        ...
        meta_data: {
          ...
          'key_mechanisms': ['glycogen replenishment', 'protein synthesis', 'hormone regulation']
        }
      },
      {
        domain: 'Recovery',
        subdomain: 'Nutrition',
        study_title: 'From Food Supplements to Functional Foods: Emerging Perspectives on Post-Exercise Recovery Nutrition',
        authors: ['Martinez-Rodriguez', 'A.', 'Cuestas-Calero', 'B.J.', 'Hernandez-Garcia', 'M.'],
        publication_year: 2024,
        journal: 'Nutrients',
        study_type: 'Systematic Review',
        evidence_level: 'High',
        ...
        citation_count: 12,
        meta_data: {
          'functional_foods': ['tart cherry juice', 'turmeric', 'omega-3 sources'],
          'bioactive_compounds': ['anthocyanins', 'curcumin', 'EPA/DHA'],
          'recovery_targets': ['muscle repair', 'glycogen replenishment', 'inflammation reduction']
        }
      },
      {
        domain: 'Recovery',
        subdomain: 'Hydration',
        study_title: 'Effectiveness of Recovery Strategies After Training and Competition in Endurance Athletes: An Umbrella Review',
        authors: ['Kellmann', 'M.', 'Bertollo', 'M.', 'Bosquet', 'L.', 'Brink', 'M.'],
        publication_year: 2024,
        ...
        meta_data: {
          ...
          'monitoring_methods': ['body weight', 'urine color', 'thirst sensation']
        }
      }
    ];
    ...
    const prehabResearch = [
      {
        ...
        study_title: 'Relative efficacy of prehabilitation interventions and their components: systematic review with network and component network meta-analyses',
        authors: ['Rodriguez-Mansilla', 'J.', 'Gonzalez-Sanchez', 'B.', 'Torres-Piles', 'S.'],
      ...
      },
      {
        ...
        study_title: 'Exercise-based injury prevention in child and adolescent sport: a systematic review and meta-analysis',
    ...
    const plyometricResearch = [
      {
        ...
        study_title: 'A meta-analysis of the effects of plyometric training on muscle strength and power in martial arts athletes',
        ...
        citation_count: 2,
        meta_data: {
          'performance_improvements': ['jumping', 'sprint_speed', 'change_of_direction', 'balance', 'strength'],
      ...
      },
      {
        ...
        study_title: 'Meta-analysis of the effect of plyometric training on the athletic performance of youth basketball players',
    ...
    const isometricResearch = [
      {
        ...
        study_title: 'Effects of isometric vs. dynamic resistance training on isometric and isokinetic muscular strength',
      ...
      },
      {
        ...
        study_title: 'The Relationship Between Isometric and Dynamic Strength Following Resistance Training',
    ...
    const allResearch = [...recoveryResearch, ...prehabResearch, ...plyometricResearch, ...isometricResearch];
    ...
    console.log(`✅ Seeded ${allResearch.length} evidence-based research studies`);
