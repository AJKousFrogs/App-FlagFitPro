...
const colorReplacements = {
  ...
  "linear-gradient(135deg, #667eea":
    "linear-gradient(135deg, var(--primary-500)",
...
function replaceColors(htmlContent) {
  ...
  updated = updated.replace(/color:\s*#3b82f6/g, "color: var(--primary-500)");
  ...
  updated = updated.replace(/color:\s*#ec4899/g, "color: var(--secondary-500)");

  // Replace rgba purple with rgba green
  updated = updated.replace(/rgba\(99,\s*102,\s*241/g, "rgba(16, 201, 107");

  // Replace rgba pink with rgba lime
  updated = updated.replace(/rgba\(236,\s*72,\s*153/g, "rgba(137, 195, 0");
...
console.log(
  `Replacing non-green colors in ${htmlFiles.length} HTML files...\n`,
);
