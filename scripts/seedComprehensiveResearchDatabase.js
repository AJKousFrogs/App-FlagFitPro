  ...
  try {
    ...
    const nutritionResearch = [
      {
        ...
        study_title:
          "The Effect of Ingesting Carbohydrate and Proteins on Athletic Performance: A Systematic Review and Meta-Analysis",
    ...
    const strengthResearch = [
      ...
      },
      {
        ...
        study_title:
          "Periodization Models for Resistance Training: A Systematic Review",
    ...
    const biomechanicsResearch = [
      {
        ...
        study_title:
          "Landing Biomechanics and ACL Injury Risk: A Systematic Review and Meta-Analysis",
      ...
      },
      {
        ...
        study_title:
          "Biomechanical Analysis of Change of Direction Movements: A Systematic Review",
    ...
    const youthResearch = [
      {
        ...
        study_title:
          "The Influence of Biological Maturation on Training Adaptations in Youth Athletes",
    ...
    const femaleResearch = [
      {
        ...
        study_title:
          "The Effects of Menstrual Cycle Phase on Athletic Performance: A Systematic Review",
    ...
    console.log(
      `✅ Seeded ${allResearch.length} additional evidence-based research studies`,
    );
