...
async function seedCommunicationTrainingDatabase() {
  ...
  try {
    ...
    const onFieldCommunication = [
      {
        ...
        description: 'Effective pre-snap communication to coordinate the offense and identify defensive alignments.',
      ...
      },
      {
        ...
        description: 'Communication between quarterback and receivers for precise route execution.',
        on_field_applications: [
      ...
      },
      {
        ...
        description: 'Communication systems for defensive backs and pass rushers.',
        on_field_applications: [
    ...
    const offFieldCommunication = [
      {
        ...
        description: 'Creating an environment where players can give and receive feedback effectively.',
        on_field_applications: [
      ...
      },
      {
        ...
        description: 'Communication skills for team captains and emerging leaders.',
        on_field_applications: [
      ...
      },
      {
        ...
        description: 'Building productive relationships and communication with coaching staff.',
        on_field_applications: [
    ...
    const allCommunicationData = [...onFieldCommunication, ...offFieldCommunication];
    ...
    console.log(`✅ Seeded ${allCommunicationData.length} communication training records`);
