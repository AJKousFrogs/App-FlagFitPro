...
import performanceDataRoutes from "./routes/performance-data.routes.js";
...
app.use("/api/v2/performance-data", performanceDataRoutes);
app.use("/api/v2/nutrition", nutritionRoutes);
