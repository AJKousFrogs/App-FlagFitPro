...
| `training_sessions`     | Training history, workload            | _(use ConsentDataReader)_   |
| `training_load_metrics` | Calculated load metrics               | _(use ConsentDataReader)_   |
| `metric_entries`        | Individual metric recordings          | _(use ConsentDataReader)_   |
| `wellness_entries`      | Sleep, stress, recovery data          | _(use ConsentDataReader)_   |
| `wellness_logs`         | Daily wellness check-ins              | _(use ConsentDataReader)_   |
