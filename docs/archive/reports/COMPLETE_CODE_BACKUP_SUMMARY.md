...
- **Backup Folder**: `react-flagfootball-app-BACKUP-20250727-132030`
...
├── react-flagfootball-app-BACKUP-20250727-132030/  # Backup copy
├── docs/                                      # Documentation
├── .git/                                      # Version control
...
├── DraggableDashboard.jsx                # Drag & drop dashboard
├── PlayersLeaderboard.jsx                # Global player rankings
├── SponsorBanner.jsx                     # Sponsor advertising system
├── WeeklyTrainingSchedule.jsx            # 7-day training planner
├── MeasurementDisplay.jsx                # Measurement display component
├── MeasurementInput.jsx                  # Measurement input component
├── MeasurementToggle.jsx                 # Imperial/Metric toggle
├── LoadingSpinner.jsx                    # Loading component
├── Navigation.jsx                        # Navigation component
├── NewNavigation.jsx                     # Updated navigation
├── PhysicalProfileCard.jsx               # Physical metrics card
├── AppLayout.jsx                         # Application layout
├── Breadcrumbs.jsx                       # Navigation breadcrumbs
├── FloatingActionButton.jsx              # FAB component
└── DraggableTrainingSchedule.jsx         # Training schedule (legacy)
```
...
src/styles/
└── wireframe.css                         # Wireframe-specific styles
```
...
- **`DESIGN_SYSTEM_REFRESH.md`** - Design system updates
- **`DESIGN_SYSTEM_CONSISTENCY_REPORT.md`** - Consistency analysis
- **`DESIGN_SYSTEM_FIXES_COMPLETED.md`** - Completed fixes
...
- **Team Chemistry** - Team dynamics metrics
- **Game Stats** - Performance statistics
- **Training Focus** - Progress tracking
...
- **Coach-Recommended Drills** - Position-specific training
...
- **3 Sponsor Categories** - GearX Pro, Chemius, LaprimaFit
- **Toggle Functionality** - Test both modes
...
This backup contains a **complete, functional FlagFit Pro application** with:

✅ **Full wireframe system** with consistent design
✅ **Complete user flow** from login to all features
✅ **Interactive dashboard** with drag & drop functionality
✅ **Players leaderboard** with XP system and sponsor rewards
✅ **Sponsor banner system** for monetization
