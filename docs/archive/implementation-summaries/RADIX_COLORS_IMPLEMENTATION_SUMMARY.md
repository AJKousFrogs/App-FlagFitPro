...
<!-- Primary Button -->
<button
  class="bg-radix-accent-11 text-white px-6 py-3 rounded-lg font-medium font-poppins"
>
  Primary Action
</button>
...
<!-- Card Component -->
<div
  class="bg-radix-background-1 border border-radix-accent-3 rounded-lg p-6 shadow-sm font-poppins"
>
...
<!-- Input Field -->
<input
  class="bg-radix-background-1 border border-radix-accent-3 rounded-md px-3 py-3 font-poppins text-radix-accent-7 focus:border-radix-accent-11 focus:ring-2 focus:ring-radix-accent-11/20"
