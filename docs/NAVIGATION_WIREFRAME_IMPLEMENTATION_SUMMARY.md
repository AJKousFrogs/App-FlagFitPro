...
const navigationItems = [
  ...
  },
  {
    ...
    subItems: [
      { name: 'Route Running', href: '/training/routes', description: 'Agility and route precision' },
      { name: 'Plyometrics', href: '/training/plyometrics', description: 'Power and explosive movement' },
      // ... more items
    ]
  }
...
*This navigation wireframe update provides a modern, accessible, and user-friendly navigation system that enhances the FlagFit Pro application's overall user experience while maintaining all existing functionality and adding new features for improved usability.* 