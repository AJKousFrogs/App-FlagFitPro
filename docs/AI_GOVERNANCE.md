...
*Source: PRIVACY_POLICY.md Section 3.3 "AI Processing"*
...
*Source: PRIVACY_POLICY.md Section 7.7 "Rights Related to Automated Decision-Making"*
...
*Source: PRIVACY_POLICY.md Section 3.3 "Request human review of any AI-generated recommendation"*
...
*Source: PRIVACY_POLICY.md Section 3.3, GDPR Article 22*
...
*Source: PRIVACY_POLICY.md Section 3.3 "Turn off AI processing entirely"*
...
export class AIPreferencesService {
  ...
  async setFeatureEnabled(feature: keyof AIPreferences['features'], enabled: boolean): Promise<void> {
    const prefs = { 
      ...this.preferences(), 
...
*Source: PRIVACY_POLICY.md Section 3.2 "We Do NOT Use Your Data To... Make money in any way"*
