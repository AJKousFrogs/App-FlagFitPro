...
Verified against live: **2026-07-03** (V2.4, via authenticated Supabase MCP) — 188 base tables, 7 views, 115 Netlify functions, 224 migration files in `supabase/migrations/`. The generated DATA_MODEL/ENDPOINTS + live snapshot were regenerated 2026-07-03.
