...
| Reference/threshold      | `readiness_gates`            | 4     | — (no athlete id)     | `id`       | —                                                 | context, threshold*low/mid/high, action*\*, methodology_citation                                                                                                                     |
...
| **ChannelService**          | `core/services/channel.service.ts`                       | **live — but it's the _chat_ channel service** (consumed by `team-chat.component`), **not** load monitoring |
