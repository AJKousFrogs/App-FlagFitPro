...
```typescript
const RISK_ZONES = {
  'under-training': { range: [0, 0.80], color: 'blue', label: 'Under-Training' },
  'sweet-spot': { range: [0.80, 1.30], color: 'green', label: 'Sweet Spot' },
  'elevated': { range: [1.30, 1.50], color: 'yellow', label: 'Elevated Risk' },
  'danger-zone': { range: [1.50, Infinity], color: 'red', label: 'Danger Zone' }
};
```
