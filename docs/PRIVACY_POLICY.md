...
- Able to pay lawyers, damages, or settlements
...
The DPO is responsible for overseeing data protection compliance and is your point of contact for any privacy-related questions or concerns.
...
Some data we collect is considered "special category" under GDPR because it relates to health:

- Injury history
- Pain levels
- Wellness indicators
- Body measurements (if you choose to input them)

**We only collect this with your explicit consent.** You can use the app without providing health data - you just won't get injury risk features.

### 2.3 What We DON'T Collect

- ❌ Financial information (we don't charge anything)
- ❌ Government IDs
- ❌ Precise location tracking
- ❌ Contacts from your phone
- ❌ Photos (unless you upload them)
...
1. **Make the app work** - Show you your training history, calculate stats
2. **Provide insights** - Analyze patterns, estimate injury risk
3. **Give recommendations** - Suggest training adjustments based on your data
4. **Enable team features** - Let coaches see team data (only with your permission)
5. **Fix problems** - Debug issues, improve the app
...
- Data brokers (we don't know any)
- Insurance companies
- Employers
- Government (unless legally required by Slovenian court order)
- Anyone who offers us money (we'd refuse anyway)
...
### 5.2 No International Transfers
...
You have the following rights under GDPR. We respect all of them.

### 7.1 Right of Access (Art. 15)

**What:** Get a copy of all data we have about you
**How:** Email merlin@ljubljanafrogs.si or use Settings > Privacy > Export Data
...
**Timeline:** Immediately (in app) or within 30 days (by email)

### 7.3 Right to Erasure (Art. 17)

**What:** Delete all your data ("right to be forgotten")
**How:** Settings > Account > Delete Account, or email us
**Timeline:** Within 30 days

### 7.4 Right to Restriction (Art. 18)

**What:** Limit how we process your data
**How:** Email us with your request
**Timeline:** Within 30 days

### 7.5 Right to Data Portability (Art. 20)

**What:** Get your data in a machine-readable format
**How:** Settings > Privacy > Export Data (JSON/CSV)
**Timeline:** Immediately (automated export)

### 7.6 Right to Object (Art. 21)

**What:** Object to processing based on legitimate interest
**How:** Email us or use privacy settings
**Timeline:** We'll stop within 30 days unless we have compelling reasons

### 7.7 Rights Related to Automated Decision-Making (Art. 22)

**What:** Not be subject to purely automated decisions with significant effects
**How:** Our AI provides recommendations only - you make decisions
**Note:** You can turn off AI entirely in settings

### 7.8 Right to Withdraw Consent

**What:** Take back consent you previously gave
**How:** Settings > Privacy, or email us
**Effect:** We'll stop that processing; doesn't affect past processing
...
We'll respond within 30 days. If we need more time (complex requests), we'll tell you within 30 days and explain why.
...
- **Access control:** Only necessary volunteers can access backend
- **Secure hosting:** Supabase provides enterprise-grade security
...
**This app is for users aged 16 and older only.**

- **16+:** Can use the app with full features
- **Under 16:** Cannot create an account

We do not knowingly collect personal data from anyone under 16 years of age. During registration, users must confirm they are 16 or older.
...
If you believe we have inadvertently collected data from someone under 16, please contact us immediately at: merlin@ljubljanafrogs.si
...
We're volunteers, so please be patient. We'll respond as soon as we can, always within 30 days for formal GDPR requests.

---

## 13. SLOVENIAN SUPERVISORY AUTHORITY
...
Most privacy policies are written by lawyers to protect companies. This one is written by athletes to be honest with other athletes.

We collect your data because the app needs it to work. We don't sell it because we're not a business. We protect it as best we can because it's the right thing to do.

### Our Promise

We're a small sports club trying to help our community train better. We have no investors to please, no shareholders to report to, and no business model that depends on your data.

**Your data helps you train. That's it.**
