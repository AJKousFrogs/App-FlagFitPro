...
-- Generated: 2025-12-01T21:01:27.644Z
...
CREATE TABLE affordable_brand_products (
  id INTEGER NOT NULL DEFAULT nextval('affordable_brand_products_id_seq'::regclass),
...
CREATE INDEX idx_affordable_brand_products_created_at ON affordable_brand_products(created_at DESC);
...
CREATE TABLE hydration_research_studies (
  id INTEGER NOT NULL DEFAULT nextval('hydration_research_studies_id_seq'::regclass),
...
CREATE INDEX idx_hydration_research_studies_created_at ON hydration_research_studies(created_at DESC);
...
CREATE TABLE user_behavior (
  id INTEGER NOT NULL DEFAULT nextval('user_behavior_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
  session_id VARCHAR(255) NOT NULL,
  page_sequence TEXT[],
...
CREATE TABLE ifaf_flag_rankings (
  id INTEGER NOT NULL DEFAULT nextval('ifaf_flag_rankings_id_seq'::regclass),
...
CREATE INDEX idx_ifaf_flag_rankings_created_at ON ifaf_flag_rankings(created_at DESC);
...
CREATE TABLE implementation_steps (
  id INTEGER NOT NULL DEFAULT nextval('implementation_steps_id_seq'::regclass),
...
CREATE INDEX idx_implementation_steps_created_at ON implementation_steps(created_at DESC);
CREATE INDEX idx_implementation_steps_user_id ON implementation_steps(user_id);
...
CREATE TABLE altitude_environmental_factors (
  id INTEGER NOT NULL DEFAULT nextval('altitude_environmental_factors_id_seq'::regclass),
...
CREATE INDEX idx_altitude_environmental_factors_created_at ON altitude_environmental_factors(created_at DESC);
...
CREATE TABLE wada_prohibited_substances (
  id INTEGER NOT NULL DEFAULT nextval('wada_prohibited_substances_id_seq'::regclass),
...
CREATE INDEX idx_wada_prohibited_substances_created_at ON wada_prohibited_substances(created_at DESC);
...
CREATE TABLE training_analytics (
  id INTEGER NOT NULL DEFAULT nextval('training_analytics_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
...
CREATE INDEX idx_training_analytics_created_at ON training_analytics(created_at DESC);
...
CREATE TABLE ifaf_elo_ratings (
  id INTEGER NOT NULL DEFAULT nextval('ifaf_elo_ratings_id_seq'::regclass),
  country VARCHAR(100) NOT NULL,
  gender VARCHAR(20) NOT NULL,
  category VARCHAR(50) NOT NULL,
...
CREATE INDEX idx_ifaf_elo_ratings_created_at ON ifaf_elo_ratings(created_at DESC);
...
CREATE TABLE supplement_wada_compliance (
  id INTEGER NOT NULL DEFAULT nextval('supplement_wada_compliance_id_seq'::regclass),
...
CREATE INDEX idx_supplement_wada_compliance_created_at ON supplement_wada_compliance(created_at DESC);
...
CREATE TABLE premium_brand_analysis (
  id INTEGER NOT NULL DEFAULT nextval('premium_brand_analysis_id_seq'::regclass),
  brand_name VARCHAR(100) NOT NULL,
  brand_website TEXT,
...
CREATE INDEX idx_premium_brand_analysis_created_at ON premium_brand_analysis(created_at DESC);
...
CREATE TABLE supplement_evidence_grades (
  id INTEGER NOT NULL DEFAULT nextval('supplement_evidence_grades_id_seq'::regclass),
...
CREATE INDEX idx_supplement_evidence_grades_created_at ON supplement_evidence_grades(created_at DESC);
...
CREATE TABLE supplement_interactions (
  id INTEGER NOT NULL DEFAULT nextval('supplement_interactions_id_seq'::regclass),
...
CREATE INDEX idx_supplement_interactions_created_at ON supplement_interactions(created_at DESC);
...
CREATE TABLE supplement_research (
  id INTEGER NOT NULL DEFAULT nextval('supplement_research_id_seq'::regclass),
...
CREATE INDEX idx_supplement_research_created_at ON supplement_research(created_at DESC);
...
CREATE TABLE local_premium_alternatives (
  id INTEGER NOT NULL DEFAULT nextval('local_premium_alternatives_id_seq'::regclass),
...
CREATE INDEX idx_local_premium_alternatives_created_at ON local_premium_alternatives(created_at DESC);
...
CREATE TABLE affordable_equipment (
  id INTEGER NOT NULL DEFAULT nextval('affordable_equipment_id_seq'::regclass),
...
CREATE INDEX idx_affordable_equipment_created_at ON affordable_equipment(created_at DESC);
...
CREATE TABLE team_resources (
  id INTEGER NOT NULL DEFAULT nextval('team_resources_id_seq'::regclass),
...
CREATE INDEX idx_team_resources_created_at ON team_resources(created_at DESC);
...
CREATE TABLE environmental_adjustments (
  id INTEGER NOT NULL DEFAULT nextval('environmental_adjustments_id_seq'::regclass),
...
CREATE INDEX idx_environmental_adjustments_created_at ON environmental_adjustments(created_at DESC);
...
CREATE TABLE realistic_budget_categories (
  id INTEGER NOT NULL DEFAULT nextval('realistic_budget_categories_id_seq'::regclass),
...
CREATE INDEX idx_realistic_budget_categories_created_at ON realistic_budget_categories(created_at DESC);
...
CREATE TABLE equipment_price_tracking (
  id INTEGER NOT NULL DEFAULT nextval('equipment_price_tracking_id_seq'::regclass),
  equipment_name VARCHAR(200) NOT NULL,
  source_url TEXT,
...
CREATE INDEX idx_equipment_price_tracking_created_at ON equipment_price_tracking(created_at DESC);
...
CREATE TABLE equipment_alternatives_comparison (
  id INTEGER NOT NULL DEFAULT nextval('equipment_alternatives_comparison_id_seq'::regclass),
...
CREATE INDEX idx_equipment_alternatives_comparison_created_at ON equipment_alternatives_comparison(created_at DESC);
...
CREATE TABLE premium_product_alternatives (
  id INTEGER NOT NULL DEFAULT nextval('premium_product_alternatives_id_seq'::regclass),
  premium_brand_id INTEGER,
...
CREATE INDEX idx_premium_product_alternatives_created_at ON premium_product_alternatives(created_at DESC);
...
CREATE TABLE budget_friendly_alternatives (
  id INTEGER NOT NULL DEFAULT nextval('budget_friendly_alternatives_id_seq'::regclass),
...
CREATE INDEX idx_budget_friendly_alternatives_created_at ON budget_friendly_alternatives(created_at DESC);
...
CREATE TABLE supplement_protocols (
  id INTEGER NOT NULL DEFAULT nextval('supplement_protocols_id_seq'::regclass),
  user_id UUID NOT NULL,
  supplement_id INTEGER NOT NULL,
...
CREATE INDEX idx_supplement_protocols_created_at ON supplement_protocols(created_at DESC);
CREATE INDEX idx_supplement_protocols_user_id ON supplement_protocols(user_id);
...
CREATE TABLE amateur_training_programs (
  id INTEGER NOT NULL DEFAULT nextval('amateur_training_programs_id_seq'::regclass),
...
CREATE INDEX idx_amateur_training_programs_created_at ON amateur_training_programs(created_at DESC);
...
CREATE TABLE cost_effective_alternatives (
  id INTEGER NOT NULL DEFAULT nextval('cost_effective_alternatives_id_seq'::regclass),
...
CREATE INDEX idx_cost_effective_alternatives_created_at ON cost_effective_alternatives(created_at DESC);
...
CREATE INDEX idx_budget_categories_created_at ON budget_categories(created_at DESC);
...
CREATE TABLE realistic_performance_plans (
  id INTEGER NOT NULL DEFAULT nextval('realistic_performance_plans_id_seq'::regclass),
...
CREATE INDEX idx_realistic_performance_plans_created_at ON realistic_performance_plans(created_at DESC);
...
CREATE TABLE diy_protocols (
  id INTEGER NOT NULL DEFAULT nextval('diy_protocols_id_seq'::regclass),
...
CREATE INDEX idx_diy_protocols_created_at ON diy_protocols(created_at DESC);
...
CREATE TABLE ifaf_hydration_protocols (
  id INTEGER NOT NULL DEFAULT nextval('ifaf_hydration_protocols_id_seq'::regclass),
...
CREATE INDEX idx_ifaf_hydration_protocols_created_at ON ifaf_hydration_protocols(created_at DESC);
...
CREATE TABLE budget_nutrition_plans (
  id INTEGER NOT NULL DEFAULT nextval('budget_nutrition_plans_id_seq'::regclass),
  plan_name VARCHAR(200) NOT NULL,
...
CREATE INDEX idx_budget_nutrition_plans_created_at ON budget_nutrition_plans(created_at DESC);
...
CREATE TABLE european_championship_protocols (
  id INTEGER NOT NULL DEFAULT nextval('european_championship_protocols_id_seq'::regclass),
...
CREATE INDEX idx_european_championship_protocols_created_at ON european_championship_protocols(created_at DESC);
...
CREATE TABLE world_championship_protocols (
  id INTEGER NOT NULL DEFAULT nextval('world_championship_protocols_id_seq'::regclass),
  championship_year INTEGER NOT NULL,
  host_country VARCHAR(100),
  climate_zone VARCHAR(100),
  teams_participating INTEGER,
...
CREATE INDEX idx_world_championship_protocols_created_at ON world_championship_protocols(created_at DESC);
...
CREATE TABLE olympic_games_protocols (
  id INTEGER NOT NULL DEFAULT nextval('olympic_games_protocols_id_seq'::regclass),
...
CREATE INDEX idx_olympic_games_protocols_created_at ON olympic_games_protocols(created_at DESC);
...
CREATE TABLE performance_plan_templates (
  id INTEGER NOT NULL DEFAULT nextval('performance_plan_templates_id_seq'::regclass),
...
CREATE INDEX idx_performance_plan_templates_created_at ON performance_plan_templates(created_at DESC);
...
CREATE TABLE creatine_research (
  id INTEGER NOT NULL DEFAULT nextval('creatine_research_id_seq'::regclass),
...
CREATE INDEX idx_creatine_research_created_at ON creatine_research(created_at DESC);
...
CREATE TABLE flag_football_positions (
  id INTEGER NOT NULL DEFAULT nextval('flag_football_positions_id_seq'::regclass),
...
CREATE INDEX idx_flag_football_positions_created_at ON flag_football_positions(created_at DESC);
...
CREATE TABLE national_team_profiles (
  id INTEGER NOT NULL DEFAULT nextval('national_team_profiles_id_seq'::regclass),
...
CREATE INDEX idx_national_team_profiles_created_at ON national_team_profiles(created_at DESC);
...
CREATE TABLE success_indicators (
  id INTEGER NOT NULL DEFAULT nextval('success_indicators_id_seq'::regclass),
...
CREATE INDEX idx_success_indicators_created_at ON success_indicators(created_at DESC);
...
CREATE TABLE community_activation_events (
  id INTEGER NOT NULL DEFAULT nextval('community_activation_events_id_seq'::regclass),
...
CREATE INDEX idx_community_activation_events_created_at ON community_activation_events(created_at DESC);
...
CREATE TABLE training_hydration_protocols (
  id INTEGER NOT NULL DEFAULT nextval('training_hydration_protocols_id_seq'::regclass),
  training_type VARCHAR(100),
...
CREATE INDEX idx_training_hydration_protocols_created_at ON training_hydration_protocols(created_at DESC);
...
CREATE TABLE supplements (
  id INTEGER NOT NULL DEFAULT nextval('supplements_id_seq'::regclass),
...
CREATE TABLE sleep_optimization_protocols (
  id INTEGER NOT NULL DEFAULT nextval('sleep_optimization_protocols_id_seq'::regclass),
...
CREATE INDEX idx_sleep_optimization_protocols_created_at ON sleep_optimization_protocols(created_at DESC);
...
CREATE TABLE sprint_training_categories (
  id INTEGER NOT NULL DEFAULT nextval('sprint_training_categories_id_seq'::regclass),
...
CREATE INDEX idx_sprint_training_categories_created_at ON sprint_training_categories(created_at DESC);
...
CREATE TABLE sprint_workouts (
  id INTEGER NOT NULL DEFAULT nextval('sprint_workouts_id_seq'::regclass),
  category_id INTEGER,
  phase_id INTEGER,
...
CREATE INDEX idx_sprint_workouts_created_at ON sprint_workouts(created_at DESC);
...
CREATE TABLE sprint_training_phases (
  id INTEGER NOT NULL DEFAULT nextval('sprint_training_phases_id_seq'::regclass),
...
CREATE INDEX idx_sprint_training_phases_created_at ON sprint_training_phases(created_at DESC);
...
CREATE TABLE agility_patterns (
  id INTEGER NOT NULL DEFAULT nextval('agility_patterns_id_seq'::regclass),
  name VARCHAR(100) NOT NULL,
...
CREATE INDEX idx_agility_patterns_created_at ON agility_patterns(created_at DESC);
...
CREATE TABLE sprint_recovery_protocols (
  id INTEGER NOT NULL DEFAULT nextval('sprint_recovery_protocols_id_seq'::regclass),
  name VARCHAR(100) NOT NULL,
...
CREATE INDEX idx_sprint_recovery_protocols_created_at ON sprint_recovery_protocols(created_at DESC);
...
CREATE TABLE player_archetypes (
  id INTEGER NOT NULL DEFAULT nextval('player_archetypes_id_seq'::regclass),
...
CREATE INDEX idx_player_archetypes_created_at ON player_archetypes(created_at DESC);
...
CREATE TABLE position_requirements (
  id INTEGER NOT NULL DEFAULT nextval('position_requirements_id_seq'::regclass),
...
CREATE INDEX idx_position_requirements_created_at ON position_requirements(created_at DESC);
...
CREATE TABLE sports_crossover_analysis (
  id INTEGER NOT NULL DEFAULT nextval('sports_crossover_analysis_id_seq'::regclass),
...
CREATE INDEX idx_sports_crossover_analysis_created_at ON sports_crossover_analysis(created_at DESC);
...
CREATE TABLE defensive_schemes (
  id INTEGER NOT NULL DEFAULT nextval('defensive_schemes_id_seq'::regclass),
...
CREATE INDEX idx_defensive_schemes_created_at ON defensive_schemes(created_at DESC);
...
CREATE TABLE nfl_combine_benchmarks (
  id INTEGER NOT NULL DEFAULT nextval('nfl_combine_benchmarks_id_seq'::regclass),
  position VARCHAR(50),
...
CREATE INDEX idx_nfl_combine_benchmarks_created_at ON nfl_combine_benchmarks(created_at DESC);
...
CREATE TABLE flag_football_performance_levels (
  id INTEGER NOT NULL DEFAULT nextval('flag_football_performance_levels_id_seq'::regclass),
...
CREATE INDEX idx_flag_football_performance_levels_created_at ON flag_football_performance_levels(created_at DESC);
...
CREATE TABLE nfl_combine_performances (
  id INTEGER NOT NULL DEFAULT nextval('nfl_combine_performances_id_seq'::regclass),
...
CREATE INDEX idx_nfl_combine_performances_created_at ON nfl_combine_performances(created_at DESC);
...
CREATE TABLE game_day_workflows (
  id INTEGER NOT NULL DEFAULT nextval('game_day_workflows_id_seq'::regclass),
...
CREATE INDEX idx_game_day_workflows_created_at ON game_day_workflows(created_at DESC);
...
CREATE TABLE sleep_guidelines (
  id INTEGER NOT NULL DEFAULT nextval('sleep_guidelines_id_seq'::regclass),
...
CREATE INDEX idx_sleep_guidelines_created_at ON sleep_guidelines(created_at DESC);
...
CREATE TABLE digital_wellness_protocols (
  id INTEGER NOT NULL DEFAULT nextval('digital_wellness_protocols_id_seq'::regclass),
  protocol_name VARCHAR(200) NOT NULL,
...
CREATE INDEX idx_digital_wellness_protocols_created_at ON digital_wellness_protocols(created_at DESC);
...
CREATE TABLE cognitive_recovery_protocols (
  id INTEGER NOT NULL DEFAULT nextval('cognitive_recovery_protocols_id_seq'::regclass),
  protocol_name VARCHAR(200) NOT NULL,
  protocol_description TEXT NOT NULL,
...
CREATE INDEX idx_cognitive_recovery_protocols_created_at ON cognitive_recovery_protocols(created_at DESC);
...
CREATE TABLE environmental_recovery_protocols (
  id INTEGER NOT NULL DEFAULT nextval('environmental_recovery_protocols_id_seq'::regclass),
  protocol_name VARCHAR(200) NOT NULL,
...
CREATE INDEX idx_environmental_recovery_protocols_created_at ON environmental_recovery_protocols(created_at DESC);
...
CREATE TABLE performance_competencies (
  id INTEGER NOT NULL DEFAULT nextval('performance_competencies_id_seq'::regclass),
...
CREATE INDEX idx_performance_competencies_created_at ON performance_competencies(created_at DESC);
...
CREATE TABLE team_chemistry (
  id INTEGER NOT NULL DEFAULT nextval('team_chemistry_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
...
CREATE INDEX idx_team_chemistry_created_at ON team_chemistry(created_at DESC);
CREATE INDEX idx_team_chemistry_user_id ON team_chemistry(user_id);
...
CREATE TABLE daily_quotes (
  id INTEGER NOT NULL DEFAULT nextval('daily_quotes_id_seq'::regclass),
...
CREATE INDEX idx_daily_quotes_created_at ON daily_quotes(created_at DESC);
...
CREATE TABLE olympic_qualification (
  id INTEGER NOT NULL DEFAULT nextval('olympic_qualification_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
...
CREATE INDEX idx_olympic_qualification_created_at ON olympic_qualification(created_at DESC);
CREATE INDEX idx_olympic_qualification_user_id ON olympic_qualification(user_id);
...
CREATE TABLE performance_benchmarks (
  id INTEGER NOT NULL DEFAULT nextval('performance_benchmarks_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
...
CREATE TABLE sponsor_rewards (
  id INTEGER NOT NULL DEFAULT nextval('sponsor_rewards_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
...
CREATE INDEX idx_sponsor_rewards_created_at ON sponsor_rewards(created_at DESC);
CREATE INDEX idx_sponsor_rewards_user_id ON sponsor_rewards(user_id);
...
CREATE TABLE sponsor_products (
  id INTEGER NOT NULL DEFAULT nextval('sponsor_products_id_seq'::regclass),
  product_name VARCHAR(200) NOT NULL,
...
CREATE INDEX idx_sponsor_products_created_at ON sponsor_products(created_at DESC);
...
CREATE TABLE wearables_data (
  id INTEGER NOT NULL DEFAULT nextval('wearables_data_id_seq'::regclass),
  user_id VARCHAR(255) NOT NULL,
...
CREATE INDEX idx_wearables_data_created_at ON wearables_data(created_at DESC);
CREATE INDEX idx_wearables_data_user_id ON wearables_data(user_id);
...
-- CREATE POLICY "analytics_events_insert_policy" ON analytics_events FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE performance_metrics ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "performance_metrics_select_policy" ON performance_metrics FOR SELECT USING (true);
-- CREATE POLICY "performance_metrics_insert_policy" ON performance_metrics FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE affordable_brand_products ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "affordable_brand_products_select_policy" ON affordable_brand_products FOR SELECT USING (true);
-- CREATE POLICY "affordable_brand_products_insert_policy" ON affordable_brand_products FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE hydration_research_studies ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "hydration_research_studies_select_policy" ON hydration_research_studies FOR SELECT USING (true);
-- CREATE POLICY "hydration_research_studies_insert_policy" ON hydration_research_studies FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE user_behavior ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "user_behavior_select_policy" ON user_behavior FOR SELECT USING (true);
-- CREATE POLICY "user_behavior_insert_policy" ON user_behavior FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE ifaf_flag_rankings ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "ifaf_flag_rankings_select_policy" ON ifaf_flag_rankings FOR SELECT USING (true);
-- CREATE POLICY "ifaf_flag_rankings_insert_policy" ON ifaf_flag_rankings FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE implementation_steps ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "implementation_steps_select_policy" ON implementation_steps FOR SELECT USING (true);
-- CREATE POLICY "implementation_steps_insert_policy" ON implementation_steps FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE users ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "users_select_policy" ON users FOR SELECT USING (true);
-- CREATE POLICY "users_insert_policy" ON users FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE altitude_environmental_factors ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "altitude_environmental_factors_select_policy" ON altitude_environmental_factors FOR SELECT USING (true);
-- CREATE POLICY "altitude_environmental_factors_insert_policy" ON altitude_environmental_factors FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE wada_prohibited_substances ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "wada_prohibited_substances_select_policy" ON wada_prohibited_substances FOR SELECT USING (true);
-- CREATE POLICY "wada_prohibited_substances_insert_policy" ON wada_prohibited_substances FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE training_analytics ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "training_analytics_select_policy" ON training_analytics FOR SELECT USING (true);
-- CREATE POLICY "training_analytics_insert_policy" ON training_analytics FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE ifaf_elo_ratings ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "ifaf_elo_ratings_select_policy" ON ifaf_elo_ratings FOR SELECT USING (true);
-- CREATE POLICY "ifaf_elo_ratings_insert_policy" ON ifaf_elo_ratings FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE supplement_wada_compliance ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "supplement_wada_compliance_select_policy" ON supplement_wada_compliance FOR SELECT USING (true);
-- CREATE POLICY "supplement_wada_compliance_insert_policy" ON supplement_wada_compliance FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE premium_brand_analysis ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "premium_brand_analysis_select_policy" ON premium_brand_analysis FOR SELECT USING (true);
-- CREATE POLICY "premium_brand_analysis_insert_policy" ON premium_brand_analysis FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE supplement_evidence_grades ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "supplement_evidence_grades_select_policy" ON supplement_evidence_grades FOR SELECT USING (true);
-- CREATE POLICY "supplement_evidence_grades_insert_policy" ON supplement_evidence_grades FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE supplement_interactions ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "supplement_interactions_select_policy" ON supplement_interactions FOR SELECT USING (true);
-- CREATE POLICY "supplement_interactions_insert_policy" ON supplement_interactions FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE supplement_research ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "supplement_research_select_policy" ON supplement_research FOR SELECT USING (true);
-- CREATE POLICY "supplement_research_insert_policy" ON supplement_research FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE local_premium_alternatives ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "local_premium_alternatives_select_policy" ON local_premium_alternatives FOR SELECT USING (true);
-- CREATE POLICY "local_premium_alternatives_insert_policy" ON local_premium_alternatives FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE affordable_equipment ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "affordable_equipment_select_policy" ON affordable_equipment FOR SELECT USING (true);
-- CREATE POLICY "affordable_equipment_insert_policy" ON affordable_equipment FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE team_resources ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "team_resources_select_policy" ON team_resources FOR SELECT USING (true);
-- CREATE POLICY "team_resources_insert_policy" ON team_resources FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE environmental_adjustments ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "environmental_adjustments_select_policy" ON environmental_adjustments FOR SELECT USING (true);
-- CREATE POLICY "environmental_adjustments_insert_policy" ON environmental_adjustments FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE realistic_budget_categories ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "realistic_budget_categories_select_policy" ON realistic_budget_categories FOR SELECT USING (true);
-- CREATE POLICY "realistic_budget_categories_insert_policy" ON realistic_budget_categories FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE equipment_price_tracking ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "equipment_price_tracking_select_policy" ON equipment_price_tracking FOR SELECT USING (true);
-- CREATE POLICY "equipment_price_tracking_insert_policy" ON equipment_price_tracking FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE equipment_alternatives_comparison ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "equipment_alternatives_comparison_select_policy" ON equipment_alternatives_comparison FOR SELECT USING (true);
-- CREATE POLICY "equipment_alternatives_comparison_insert_policy" ON equipment_alternatives_comparison FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE premium_product_alternatives ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "premium_product_alternatives_select_policy" ON premium_product_alternatives FOR SELECT USING (true);
-- CREATE POLICY "premium_product_alternatives_insert_policy" ON premium_product_alternatives FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE budget_friendly_alternatives ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "budget_friendly_alternatives_select_policy" ON budget_friendly_alternatives FOR SELECT USING (true);
-- CREATE POLICY "budget_friendly_alternatives_insert_policy" ON budget_friendly_alternatives FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE supplement_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "supplement_protocols_select_policy" ON supplement_protocols FOR SELECT USING (true);
-- CREATE POLICY "supplement_protocols_insert_policy" ON supplement_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE amateur_training_programs ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "amateur_training_programs_select_policy" ON amateur_training_programs FOR SELECT USING (true);
-- CREATE POLICY "amateur_training_programs_insert_policy" ON amateur_training_programs FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE cost_effective_alternatives ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "cost_effective_alternatives_select_policy" ON cost_effective_alternatives FOR SELECT USING (true);
-- CREATE POLICY "cost_effective_alternatives_insert_policy" ON cost_effective_alternatives FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE budget_categories ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "budget_categories_select_policy" ON budget_categories FOR SELECT USING (true);
-- CREATE POLICY "budget_categories_insert_policy" ON budget_categories FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE realistic_performance_plans ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "realistic_performance_plans_select_policy" ON realistic_performance_plans FOR SELECT USING (true);
-- CREATE POLICY "realistic_performance_plans_insert_policy" ON realistic_performance_plans FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE diy_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "diy_protocols_select_policy" ON diy_protocols FOR SELECT USING (true);
-- CREATE POLICY "diy_protocols_insert_policy" ON diy_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE ifaf_hydration_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "ifaf_hydration_protocols_select_policy" ON ifaf_hydration_protocols FOR SELECT USING (true);
-- CREATE POLICY "ifaf_hydration_protocols_insert_policy" ON ifaf_hydration_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE budget_nutrition_plans ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "budget_nutrition_plans_select_policy" ON budget_nutrition_plans FOR SELECT USING (true);
-- CREATE POLICY "budget_nutrition_plans_insert_policy" ON budget_nutrition_plans FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE european_championship_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "european_championship_protocols_select_policy" ON european_championship_protocols FOR SELECT USING (true);
-- CREATE POLICY "european_championship_protocols_insert_policy" ON european_championship_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE world_championship_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "world_championship_protocols_select_policy" ON world_championship_protocols FOR SELECT USING (true);
-- CREATE POLICY "world_championship_protocols_insert_policy" ON world_championship_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE olympic_games_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "olympic_games_protocols_select_policy" ON olympic_games_protocols FOR SELECT USING (true);
-- CREATE POLICY "olympic_games_protocols_insert_policy" ON olympic_games_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE performance_plan_templates ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "performance_plan_templates_select_policy" ON performance_plan_templates FOR SELECT USING (true);
-- CREATE POLICY "performance_plan_templates_insert_policy" ON performance_plan_templates FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE creatine_research ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "creatine_research_select_policy" ON creatine_research FOR SELECT USING (true);
-- CREATE POLICY "creatine_research_insert_policy" ON creatine_research FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE flag_football_positions ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "flag_football_positions_select_policy" ON flag_football_positions FOR SELECT USING (true);
-- CREATE POLICY "flag_football_positions_insert_policy" ON flag_football_positions FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE national_team_profiles ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "national_team_profiles_select_policy" ON national_team_profiles FOR SELECT USING (true);
-- CREATE POLICY "national_team_profiles_insert_policy" ON national_team_profiles FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE success_indicators ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "success_indicators_select_policy" ON success_indicators FOR SELECT USING (true);
-- CREATE POLICY "success_indicators_insert_policy" ON success_indicators FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE community_activation_events ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "community_activation_events_select_policy" ON community_activation_events FOR SELECT USING (true);
-- CREATE POLICY "community_activation_events_insert_policy" ON community_activation_events FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE training_hydration_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "training_hydration_protocols_select_policy" ON training_hydration_protocols FOR SELECT USING (true);
-- CREATE POLICY "training_hydration_protocols_insert_policy" ON training_hydration_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE supplements ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "supplements_select_policy" ON supplements FOR SELECT USING (true);
-- CREATE POLICY "supplements_insert_policy" ON supplements FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sleep_optimization_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sleep_optimization_protocols_select_policy" ON sleep_optimization_protocols FOR SELECT USING (true);
-- CREATE POLICY "sleep_optimization_protocols_insert_policy" ON sleep_optimization_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sprint_training_categories ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sprint_training_categories_select_policy" ON sprint_training_categories FOR SELECT USING (true);
-- CREATE POLICY "sprint_training_categories_insert_policy" ON sprint_training_categories FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sprint_workouts ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sprint_workouts_select_policy" ON sprint_workouts FOR SELECT USING (true);
-- CREATE POLICY "sprint_workouts_insert_policy" ON sprint_workouts FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sprint_training_phases ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sprint_training_phases_select_policy" ON sprint_training_phases FOR SELECT USING (true);
-- CREATE POLICY "sprint_training_phases_insert_policy" ON sprint_training_phases FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE agility_patterns ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "agility_patterns_select_policy" ON agility_patterns FOR SELECT USING (true);
-- CREATE POLICY "agility_patterns_insert_policy" ON agility_patterns FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sprint_recovery_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sprint_recovery_protocols_select_policy" ON sprint_recovery_protocols FOR SELECT USING (true);
-- CREATE POLICY "sprint_recovery_protocols_insert_policy" ON sprint_recovery_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE player_archetypes ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "player_archetypes_select_policy" ON player_archetypes FOR SELECT USING (true);
-- CREATE POLICY "player_archetypes_insert_policy" ON player_archetypes FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE position_requirements ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "position_requirements_select_policy" ON position_requirements FOR SELECT USING (true);
-- CREATE POLICY "position_requirements_insert_policy" ON position_requirements FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sports_crossover_analysis ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sports_crossover_analysis_select_policy" ON sports_crossover_analysis FOR SELECT USING (true);
-- CREATE POLICY "sports_crossover_analysis_insert_policy" ON sports_crossover_analysis FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE defensive_schemes ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "defensive_schemes_select_policy" ON defensive_schemes FOR SELECT USING (true);
-- CREATE POLICY "defensive_schemes_insert_policy" ON defensive_schemes FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE nfl_combine_benchmarks ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "nfl_combine_benchmarks_select_policy" ON nfl_combine_benchmarks FOR SELECT USING (true);
-- CREATE POLICY "nfl_combine_benchmarks_insert_policy" ON nfl_combine_benchmarks FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE flag_football_performance_levels ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "flag_football_performance_levels_select_policy" ON flag_football_performance_levels FOR SELECT USING (true);
-- CREATE POLICY "flag_football_performance_levels_insert_policy" ON flag_football_performance_levels FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE nfl_combine_performances ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "nfl_combine_performances_select_policy" ON nfl_combine_performances FOR SELECT USING (true);
-- CREATE POLICY "nfl_combine_performances_insert_policy" ON nfl_combine_performances FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE game_day_workflows ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "game_day_workflows_select_policy" ON game_day_workflows FOR SELECT USING (true);
-- CREATE POLICY "game_day_workflows_insert_policy" ON game_day_workflows FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sleep_guidelines ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sleep_guidelines_select_policy" ON sleep_guidelines FOR SELECT USING (true);
-- CREATE POLICY "sleep_guidelines_insert_policy" ON sleep_guidelines FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE digital_wellness_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "digital_wellness_protocols_select_policy" ON digital_wellness_protocols FOR SELECT USING (true);
-- CREATE POLICY "digital_wellness_protocols_insert_policy" ON digital_wellness_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE cognitive_recovery_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "cognitive_recovery_protocols_select_policy" ON cognitive_recovery_protocols FOR SELECT USING (true);
-- CREATE POLICY "cognitive_recovery_protocols_insert_policy" ON cognitive_recovery_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE environmental_recovery_protocols ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "environmental_recovery_protocols_select_policy" ON environmental_recovery_protocols FOR SELECT USING (true);
-- CREATE POLICY "environmental_recovery_protocols_insert_policy" ON environmental_recovery_protocols FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE performance_competencies ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "performance_competencies_select_policy" ON performance_competencies FOR SELECT USING (true);
-- CREATE POLICY "performance_competencies_insert_policy" ON performance_competencies FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE team_chemistry ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "team_chemistry_select_policy" ON team_chemistry FOR SELECT USING (true);
-- CREATE POLICY "team_chemistry_insert_policy" ON team_chemistry FOR INSERT WITH CHECK (auth.uid() = user_id);
...
-- CREATE POLICY "daily_quotes_select_policy" ON daily_quotes FOR SELECT USING (true);
-- CREATE POLICY "daily_quotes_insert_policy" ON daily_quotes FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE olympic_qualification ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "olympic_qualification_select_policy" ON olympic_qualification FOR SELECT USING (true);
-- CREATE POLICY "olympic_qualification_insert_policy" ON olympic_qualification FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE performance_benchmarks ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "performance_benchmarks_select_policy" ON performance_benchmarks FOR SELECT USING (true);
-- CREATE POLICY "performance_benchmarks_insert_policy" ON performance_benchmarks FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sponsor_rewards ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sponsor_rewards_select_policy" ON sponsor_rewards FOR SELECT USING (true);
-- CREATE POLICY "sponsor_rewards_insert_policy" ON sponsor_rewards FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE sponsor_products ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "sponsor_products_select_policy" ON sponsor_products FOR SELECT USING (true);
-- CREATE POLICY "sponsor_products_insert_policy" ON sponsor_products FOR INSERT WITH CHECK (auth.uid() = user_id);

-- ALTER TABLE wearables_data ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "wearables_data_select_policy" ON wearables_data FOR SELECT USING (true);
-- CREATE POLICY "wearables_data_insert_policy" ON wearables_data FOR INSERT WITH CHECK (auth.uid() = user_id);
