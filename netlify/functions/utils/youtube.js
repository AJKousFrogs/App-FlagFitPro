...
const CURATED_DRILL_VIDEO_IDS = {
  ...
  // Field/sprint warmup
  "easy jog": "paqAzWbLIUw",
  "mini band lateral walks": "FBOzDnSCOCQ",
  "calf raises": "9PjqDtVwXwU",
  "slow calf raises": "9PjqDtVwXwU",
  "toy soldiers": "u4-FjJHALlQ",
  "acceleration builds 10m": "vJRLJbLiRdo",
  "progressive sprints 20m": "I8O4YULZ0ls",
  "5 10 5 shuttle": "wAn7kH6f_rw",
  // Plank activation block (mandatory daily)
  "straight plank": "Pk6P-q1UYYI",
  "front plank": "Pk6P-q1UYYI",
  "single arm plank": "Pk6P-q1UYYI",
  "one arm plank": "Pk6P-q1UYYI",
  // Gym/fitness warmup
  "jump rope": "u3B3NxKiPuA",
  "bike air bike": "KlLpde1qcLs",
  "dead bug": "AThVe2U51E8",
  "lunge with reach": "8dIHS_UVfQ4",
  "sled push": "VNHEuCjuaAI",
  "med ball slams": "VNHEuCjuaAI",
  "medicine ball slams": "VNHEuCjuaAI",
  "squat to stand": "jWMzLJzYqUE",
  "pogo jumps": "bG9TIW87bqg",
  "pogo": "bG9TIW87bqg",
  "bicycle spin": "KlLpde1qcLs",
  // Recovery warmup
  "easy walk light movement": "qZ_KgFnRlhI",
  "foam roll legs back": "gfMZBbxLlyw",
  "cat cow": "FGIGlBUFbKc",
  "cat-cow": "FGIGlBUFbKc",
  "pigeon pose": "qZ_KgFnRlhI",
  "hip 90 90 stretch": "v_ZnFMgCiAg",
  "seated hamstring stretch": "LB2V2jVHudc",
  "hip flexor lunge stretch": "v_ZnFMgCiAg",
  "thoracic rotations": "FGIGlBUFbKc",
  "t spine rotation": "FGIGlBUFbKc",
  "world s greatest stretch": "OWQa_MJb5h0",
  "worlds greatest stretch": "OWQa_MJb5h0",
  "lateral band walks": "FBOzDnSCOCQ",
  "ankle circles hip circles": "ghwdVE4xn-U",
  // QB/center arm care
  "band external rotations": "zJiNB0cFyuI",
  "scap push ups": "zJiNB0cFyuI",
  "scap pushups": "zJiNB0cFyuI",
  "wrist forearm prep": "RWPOU9RCTCY",
  // WR/DB & blitzer overrides
  "deceleration drops": "uOvmzs6FGMM",
  "pursuit angle sprints": "vJRLJbLiRdo",
  "shuffle to sprint": "FBOzDnSCOCQ",
