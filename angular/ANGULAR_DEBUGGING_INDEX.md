> ⚠️ **Scope Notice**
>
> This document is an **Angular developer helper index**.
> It covers debugging, testing, and diagnostics only.
>
> For architecture, design system, security, or product documentation,
> see `docs/DOCS_INDEX.md`.

# 🔧 Angular Development - Debugging & Testing Index
...
2. E2E tests: see **[e2e/README.md](./e2e/README.md)**
...
### 4. debugging-signals-examples.ts
...
Versions are defined in `package.json` and `angular.json`.
