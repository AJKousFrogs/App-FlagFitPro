...
const iconButtonAudit: {
  component: string;
  buttons: Array<{ type: string; hasLabel: boolean; location: string }>;
}[] = [
  {
    ...
    buttons: [
      {
        ...
        hasLabel: true,
        location: "Line 45 - has ariaLabel",
      },
      {
        type: "Search icon",
        hasLabel: true,
        location: "Line 52 - has ariaLabel",
      },
      {
        type: "User menu",
        hasLabel: true,
        location: "Line 60 - has ariaLabel",
      },
    ],
  },
  {
    ...
    buttons: [
      {
        type: "Close button",
        hasLabel: true,
        location: 'Line 47 - aria-label="Close drawer"',
      },
    ],
  },
  {
    ...
    buttons: [
      {
        type: "Close button",
        hasLabel: true,
        location: "Built-in PrimeNG accessibility",
      },
    ],
  },
  {
    ...
    buttons: [
      {
        type: "Previous/Next",
        hasLabel: false,
        location: "Lines 45-50 - Icon-only navigation",
      },
    ],
  },
  {
    ...
    buttons: [
      {
        type: "Drag handle",
        hasLabel: false,
        location: "Line 35 - Icon indicator",
      },
    ],
  },
  {
    ...
    buttons: [
      {
        type: "Edit/Delete icons",
        hasLabel: false,
        location: "Template - Action buttons",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    buttons: [
      {
        type: "Formatting buttons",
        hasLabel: false,
        location: "Toolbar - Icon-only",
      },
    ],
  },
  {
    ...
    buttons: [
      {
        type: "Star icons",
        hasLabel: true,
        location: "Interactive - aria-label on each star",
      },
    ],
  },
];
...
(function runAudit() {
  ...
  const total = iconButtonAudit.reduce(
    (sum, comp) => sum + comp.buttons.length,
    0,
  );
  ...
  console.log(
    `  Without labels: ${withoutLabels} ${withoutLabels > 0 ? "❌" : "✅"}`,
  );
  ...
  if (withoutLabels > 0) {
    ...
    console.log("```html");
    console.log(
      '<button (click)="edit(item)" aria-label="Edit {{item.name}}">',
    );
