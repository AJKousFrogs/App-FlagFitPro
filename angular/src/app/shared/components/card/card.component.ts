...
@Component({
  ...
  styles: [`
    ...
    .card-gradient {
      background: linear-gradient(135deg, var(--color-brand-primary) 0%, var(--color-brand-secondary, #4caf50) 100%);
...
export class CardComponent {
  ...
  variant = input<'default' | 'elevated' | 'outlined' | 'interactive' | 'gradient'>('default');
