import { Component, input, output, signal, viewChild, ElementRef, ChangeDetectionStrategy, effect, HostListener } from '@angular/core';
...
@Component({
  ...
  styles: [`
    ...
    .popover-top .arrow-top {
      ...
      border-color: var(--p-surface-border) transparent transparent transparent;
    }
    ...
    .popover-bottom .arrow-bottom {
      ...
      border-color: transparent transparent var(--p-surface-border) transparent;
    }
    ...
    .popover-left .arrow-left {
      ...
      border-color: transparent transparent transparent var(--p-surface-border);
    }
  `]
})
