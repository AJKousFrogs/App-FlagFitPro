      ...
      <div class="measurement-form">
        ...
        <div class="form-field">
          <app-input-number
            ...
            (valueChange)="onMeasurementInput('weight', $event)"
            [minFractionDigits]="1"
            [maxFractionDigits]="1"
        ...
        <div class="form-field">
          <app-input-number
            ...
            (valueChange)="onMeasurementInput('bodyFat', $event)"
            [minFractionDigits]="1"
            [maxFractionDigits]="1"
            [min]="1"
            [max]="60"
        ...
        <div class="form-field">
          <app-input-number
            ...
            (valueChange)="onMeasurementInput('muscleMass', $event)"
            [minFractionDigits]="1"
            [maxFractionDigits]="1"
        ...
        <div class="form-field">
          <app-input-number
            ...
            (valueChange)="onMeasurementInput('bodyWater', $event)"
            [minFractionDigits]="1"
            [maxFractionDigits]="1"
            [min]="30"
            [max]="80"
        ...
        <div class="form-field">
          <app-input-number
            ...
            (valueChange)="onMeasurementInput('basalMetabolicRate', $event)"
            [min]="800"
            [max]="4000"
