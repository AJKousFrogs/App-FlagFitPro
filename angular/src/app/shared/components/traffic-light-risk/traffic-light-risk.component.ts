  ...
  template: `
    <div class="traffic-light-container">
      ...
      <div class="traffic-light" [class]="'risk-' + currentRisk().level">
        <div class="light red" [class.active]="currentRisk().level === 'danger-zone'">
          <div class="light-glow"></div>
          <div class="light-label">Danger</div>
        </div>
        <div class="light yellow" [class.active]="currentRisk().level === 'elevated-risk'">
          <div class="light-glow"></div>
          <div class="light-label">Caution</div>
        </div>
        <div class="light green" [class.active]="currentRisk().level === 'sweet-spot'">
          <div class="light-glow"></div>
          <div class="light-label">Optimal</div>
        </div>
        <div class="light orange" [class.active]="currentRisk().level === 'under-training'">
          <div class="light-glow"></div>
          <div class="light-label">Under</div>
        </div>
        <div class="light gray" [class.active]="currentRisk().level === 'no-data'">
          <div class="light-glow"></div>
