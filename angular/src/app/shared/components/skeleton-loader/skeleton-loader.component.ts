...
@Component({
  ...
  template: `
    @switch (variant()) {
      ...
      @case ('table-row') {
        <div class="skeleton-table-row" [style.animation-delay]="animationDelay()">
      ...
      @case ('stat-card') {
        <div class="skeleton-stat-card" [style.animation-delay]="animationDelay()">
      ...
      @case ('workout-card') {
        <div class="skeleton-workout-card" [style.animation-delay]="animationDelay()">
      ...
      @case ('player-card') {
        <div class="skeleton-player-card" [style.animation-delay]="animationDelay()">
          <div class="skeleton skeleton-avatar" style="width: 80px; height: 80px"></div>
          <div class="skeleton skeleton-title" style="width: 60%; margin: var(--space-3) auto 0"></div>
          <div class="skeleton skeleton-text" style="width: 40%; margin: var(--space-2) auto 0"></div>
      ...
      @case ('list-item') {
        <div class="skeleton-list-item" [style.animation-delay]="animationDelay()">
      ...
      @case ('paragraph') {
        <div class="skeleton-paragraph" [style.animation-delay]="animationDelay()">
      ...
      @case ('profile-header') {
        <div class="skeleton-profile-header" [style.animation-delay]="animationDelay()">
      ...
      @case ('dashboard-widget') {
        <div class="skeleton-dashboard-widget" [style.animation-delay]="animationDelay()">
...
export class SkeletonRepeatComponent {
  ...
  containerClass = computed(() => this.layout() !== "vertical" ? this.layout() : "");
}
