        ...
        @if (loading()) {
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()">
            ...
            <fieldset class="form-section">
              ...
              <div class="form-group">
                <label for="credentialNumber">Credential Number</label>
                <input
                  id="credentialNumber"
                  type="text"
                  formControlName="credentialNumber"
                  placeholder="e.g., CDR-123456"
                  class="form-input"
                />
              </div>

              <div class="form-group">
                <label for="credentialIssuingBody">Issuing Body</label>
                <input
                  id="credentialIssuingBody"
                  type="text"
                  formControlName="credentialIssuingBody"
                  placeholder="e.g., Commission on Dietetic Registration (CDR)"
                  class="form-input"
                />
              </div>
            </fieldset>
            ...
            <fieldset class="form-section">
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  placeholder="e.g., MS Nutrition from University X, BS Dietetics"
                  class="form-textarea"
                ></textarea>
              </div>
...
export class NutritionistOnboardingComponent implements OnInit {
  ...
  certifications = ["ISSN-SNS", "CISSN", "CSSD", "Other"];
  ...
  private loadExistingProfile() {
    ...
    this.api.get("/api/staff/nutritionist-profile").subscribe({
      next: (response: any) => {
        const profile = response?.data || response;
        if (profile) {
          this.form.patchValue({
            credentialType: profile.credential_type || "",
            credentialNumber: profile.credential_number || "",
            credentialIssuingBody: profile.credential_issuing_body || "",
