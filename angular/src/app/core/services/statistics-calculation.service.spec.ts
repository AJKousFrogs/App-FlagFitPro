...
describe("StatisticsCalculationService", () => {
  ...
  describe("Completion Percentage", () => {
    ...
    it("should throw on negative values", () => {
      expect(() => service.calculateCompletionPercentage(-1, 10)).toThrowError(
        "Stats cannot be negative",
      );
    });

    it("should throw when completions exceed attempts", () => {
      expect(() => service.calculateCompletionPercentage(20, 10)).toThrowError(
    ...
    it("should throw on non-integer values", () => {
      expect(() =>
        service.calculateCompletionPercentage(10.5, 20),
  ...
  describe("Drop Rate Calculation", () => {
    ...
    it("should throw when drops exceed targets", () => {
      expect(() => service.calculateDropRate(10, 5)).toThrowError(
        "Drops cannot exceed targets",
      );
    });
  ...
  describe("Streak Calculation", () => {
    ...
    it("should handle timezone changes correctly", () => {
      ...
      const result = service.calculateStreak(workouts, new Date("2025-12-08"));
  ...
  describe("BMI Calculation", () => {
    ...
    it("should throw on invalid weight", () => {
      expect(() => service.calculateBMI(20, 180)).toThrowError(
        "Weight must be between 30-300 kg",
      );
    });

    it("should throw on invalid height", () => {
      expect(() => service.calculateBMI(75, 50)).toThrowError(
  ...
  describe("Body Fat Calculation", () => {
    ...
    it("should require hips for females", () => {
      expect(() =>
        service.calculateBodyFat(75, 35, undefined, 165, "female"),
      ).toThrowError("Hip measurement required");
    });

    it("should validate waist measurement", () => {
      expect(() =>
        service.calculateBodyFat(30, 40, undefined, 180, "male"),
