...
const SPRINT_RESEARCH: Record<string, SprintResearchReference> = {
  haugen_2019: {
...
const SPRINT_PROTOCOLS: Record<string, SprintProtocol> = {
  // ========================================
...
const TECHNIQUE_CHECKPOINTS: SprintTechniqueCheckpoint[] = [
  {
    phase: "start",
    keyPoints: [
...
const PHASE_GUIDELINES: Record<string, SprintPhaseGuidelines> = {
  foundation: {
