        ...
        <p-card *ngIf="activeWorkout()" class="active-workout-card">
          <ng-template pTemplate="header">
            <div class="workout-header">
              ...
              <p-tag [value]="activeWorkout()?.completed ? 'Completed' : 'In Progress'" 
          ...
          <div class="exercises-list">
            <div *ngFor="let exercise of activeWorkout()?.exercises" class="exercise-item">
              ...
              <div class="exercise-actions">
                <p-checkbox [(ngModel)]="exercise.completed" 
                           [binary]="true" 
          ...
          <div class="workout-actions">
            <p-button label="Save Progress" [outlined]="true" (onClick)="saveWorkout()"></p-button>
            <p-button label="Complete Workout" (onClick)="completeWorkout()"></p-button>
          </div>
        </p-card>
          ...
          <div class="workouts-list">
            <div *ngFor="let workout of workoutHistory()" class="workout-item">
              <div class="workout-info">
                ...
                <p class="workout-stats">{{ workout.exercises.length }} exercises</p>
              </div>
              <div class="workout-status">
                <p-tag [value]="workout.completed ? 'Completed' : 'Incomplete'" 
    ...
    this.workoutHistory.set([
      {
        ...
        date: '2024-03-15',
        exercises: [
          { id: '1', name: 'Bench Press', sets: 3, reps: 10, weight: 185, completed: true },
          { id: '2', name: 'Shoulder Press', sets: 3, reps: 10, weight: 135, completed: true }
        ],
        completed: true
      },
      {
        ...
        date: '2024-03-14',
        exercises: [
          { id: '3', name: 'Squats', sets: 4, reps: 8, weight: 225, completed: true },
          { id: '4', name: 'Deadlifts', sets: 3, reps: 6, weight: 275, completed: true }
        ],
        completed: true
      }
    ]);
