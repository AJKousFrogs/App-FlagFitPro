      ...
      <div class="stats-grid">
        <div class="stat-card" role="group" aria-labelledby="stat-total-label">
          ...
          <div class="stat-content stat-block__content">
            ...
            <span class="stat-block__label" id="stat-total-label"
              >Total Videos</span
            >
          </div>
        </div>
        <div
          class="stat-card"
          role="group"
          aria-labelledby="stat-approved-label"
        >
          ...
          <div class="stat-content stat-block__content">
            ...
            <span class="stat-block__label" id="stat-approved-label"
              >Approved</span
            >
          </div>
        </div>
        ...
        >
          ...
          <div class="stat-content stat-block__content">
            ...
            <span class="stat-block__label" id="stat-pending-label"
              >Pending Review</span
            >
          </div>
        </div>
        <div
          class="stat-card"
          role="group"
          aria-labelledby="stat-playlists-label"
        >
          <div class="stat-icon" aria-hidden="true">
          ...
          <div class="stat-content stat-block__content">
            ...
            <span class="stat-block__label" id="stat-playlists-label"
              >Playlists</span
            >
          </div>
        </div>
