        ...
        <div class="chat-header">
          <div class="header-content">
            ...
            <p class="chat-subtitle">
              {{ currentChannel().members }} members • {{ currentChannel().online }} online
            </p>
          </div>
          <div class="chat-actions">
            <p-button icon="pi pi-phone" [text]="true" [rounded]="true" 
                     ariaLabel="Start voice call"></p-button>
            <p-button icon="pi pi-video" [text]="true" [rounded]="true" 
                     ariaLabel="Start video call"></p-button>
            <p-button icon="pi pi-cog" [text]="true" [rounded]="true" 
                     ariaLabel="Channel settings"></p-button>
          </div>
        </div>
            ...
            <p-card class="channels-card">
              ...
              <div class="channels-list">
                <div *ngFor="let channel of channels(); trackBy: trackByChannelId" 
                  ...
                  <p-badge *ngIf="channel.unread" [value]="channel.unread" severity="danger"></p-badge>
                </div>
              </div>
            </p-card>
          </div>
          ...
          <div class="messages-area">
              ...
              <div class="messages-list">
                <div *ngFor="let message of messages(); trackBy: trackByMessageId" 
                  ...
                  <p-avatar [label]="message.authorInitials" 
                           styleClass="mr-2" 
                           shape="circle"
                           [style]="{'background-color': getAvatarColor(message.authorInitials), 'color': '#fff'}">
                  </p-avatar>
            ...
            <div class="message-input-container">
              <input
                ...
                class="message-input">
              <p-button icon="pi pi-send" (onClick)="sendMessage()" 
                       [disabled]="!newMessage.trim()"></p-button>
            </div>
          </div>
        </div>
      </div>
...
export class ChatComponent implements OnInit, AfterViewInit {
  ...
  newMessage = '';
  currentChannel = signal<Channel>({ id: '1', name: 'team-general', members: 24, online: 8 });
