...
@Component({
      ...
      <div class="settings-content">
        ...
        <p-card styleClass="status-card">
          ...
          <div class="info-notice">
            ...
            <p>As the founding superadmin, you have full control over the platform. Only you can add additional superadmins.</p>
          </div>
        </p-card>
        ...
        <p-card>
          ...
          @if (isLoading()) {
            ...
            <p-table [value]="superadmins()" [tableStyle]="{ 'min-width': '50rem' }">
              <ng-template pTemplate="header">
                <tr>
                  <th>Email</th>
                  <th>Granted</th>
        ...
        <p-card>
          ...
          <div class="settings-list">
            <div class="setting-item">
              <div class="setting-info">
                ...
                <p>Require teams to specify their Olympic preparation track (LA 2028 / Brisbane 2032)</p>
              </div>
              <label class="toggle">
                <input type="checkbox" [checked]="requireOlympicTrack" disabled />
            ...
            <div class="setting-item">
              <div class="setting-info">
                ...
                <p>Automatically approve player role requests (not admin/coach)</p>
              </div>
              <label class="toggle">
                <input type="checkbox" [checked]="autoApprovePlayers" disabled />
                <span class="toggle-slider"></span>
              </label>
            </div>
            ...
            <div class="setting-item">
              <div class="setting-info">
                ...
                <p>Require federation affiliation verification for team approval</p>
              </div>
              <label class="toggle">
                <input type="checkbox" [checked]="federationVerification" disabled />
                <span class="toggle-slider"></span>
              </label>
            </div>
          </div>
          ...
          <div class="info-notice info">
            <i class="pi pi-info-circle"></i>
            <p>Platform settings are currently managed at the database level. Contact the development team for configuration changes.</p>
          </div>
        </p-card>
        ...
        <p-card styleClass="olympic-card">
          ...
          <div class="olympic-tracks">
            <div class="track-card">
              ...
              <p class="track-desc">First Olympic Games featuring Flag Football</p>
            </div>
            <div class="track-card">
              <h4>Brisbane 2032</h4>
          ...
          <p class="mission-text">
            This platform is exclusively for athletes and teams preparing for Olympic competition.
            All team and admin approvals should consider the applicant's commitment to Olympic-level preparation.
          </p>
        </p-card>
      </div>
          ...
          <div class="modal-dialog" (click)="$event.stopPropagation()">
            ...
            <div class="modal-body">
              ...
              <div class="warning-notice">
                ...
                <p>Superadmins have full control over the platform including approving teams and managing other superadmins. Only grant this access to trusted individuals.</p>
              </div>
            </div>
  ...
  styles: [`
    ...
    :host ::ng-deep .olympic-card {
      background: linear-gradient(135deg, var(--ds-primary-green-ultra-subtle), white);
      border: 1px solid var(--ds-primary-green-subtle);
    }
...
export class SuperadminSettingsComponent implements OnInit {
  ...
  async loadSuperadmins(): Promise<void> {
    ...
    try {
      ...
      this.superadmins.set(admins.map(a => ({
        user_id: a.user_id,
  ...
  async addNewSuperadmin(): Promise<void> {
    ...
    alert('To add a superadmin, you need to find their user ID first. This feature requires looking up the user by email in the database.');
