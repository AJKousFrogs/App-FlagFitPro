            ...
            <p-card class="create-post-card">
              ...
              <div class="post-actions">
                <div class="post-options">
                  <p-button icon="pi pi-image" [text]="true" label="Photo"></p-button>
                  <p-button icon="pi pi-video" [text]="true" label="Video"></p-button>
                  <p-button icon="pi pi-chart-bar" [text]="true" label="Poll"></p-button>
                </div>
                <p-button label="Post" (onClick)="createPost()" [disabled]="!newPostContent.trim()"></p-button>
              </div>
            </p-card>
              ...
              <p-card *ngFor="let post of posts(); trackBy: trackByPostId" class="post-card">
                <div class="post-header">
                  ...
                  <div class="post-info">
                    ...
                    <div class="post-meta">
                      {{ post.timeAgo }}
                      <span *ngIf="post.location"> • <i class="pi pi-map-marker"></i> {{ post.location }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="post-engagement">
                  <div class="engagement-stats">
                    <span><i class="pi pi-thumbs-up"></i> {{ post.likes }} likes</span>
                    <span><i class="pi pi-comments"></i> {{ post.comments }} comments</span>
                    <span><i class="pi pi-share-alt"></i> {{ post.shares }} shares</span>
                  </div>
    ...
    this.posts.set([
      {
        ...
        content: 'Great practice session today! I\'m seeing incredible improvement in everyone\'s route running. The precision passing drill really paid off. Keep up the momentum team!',
        likes: 24,
        comments: 8,
        shares: 3,
        isLiked: false,
      ...
      },
      {
        ...
        content: 'What an incredible weekend! Our team played phenomenally and took home the championship trophy. Special thanks to everyone who supported us.',
        likes: 87,
        comments: 23,
        shares: 12,
        isLiked: true,
