...
export class ProgramBuilderComponent implements OnInit {
  ...
  private loadDemoData(): void {
    ...
    this.programs.set([
      ...
      {
        id: "2",
        name: "Return-to-Play: Alex Thompson",
        description: "ACL sprain recovery protocol",
        type: "rtp",
        status: "active",
        startDate: "2025-12-15",
        durationWeeks: 6,
        currentWeek: 4,
        currentPhase: "Stage 4",
        assignedCount: 1,
        compliance: 92,
        phases: [
      ...
      },
      {
        ...
        description: "Draft program for summer season",
        type: "off-season",
        status: "draft",
