    ...
    <app-main-layout>
      <div class="coach-page">
        ...
        <p-card class="chart-card">
          ...
          <p-chart *ngIf="teamChartData()" type="line" [data]="teamChartData()" 
        ...
        <p-card class="table-card">
          ...
          <p-table [value]="teamMembers()" [paginator]="true" [rows]="10" 
            ...
            <ng-template pTemplate="body" let-member>
              <tr [attr.data-member-id]="member.id">
                ...
                <td>
                  <p-tag [value]="member.performance + '%'" 
