...
export class PlayerDevelopmentComponent implements OnInit {
  ...
  private loadDemoData(): void {
    ...
    this.assessments.set([
      { skill: "Route Running", score: 85, grade: "Excellent" },
      { skill: "Catching Ability", score: 78, grade: "Good" },
      { skill: "Release Technique", score: 88, grade: "Excellent" },
      { skill: "YAC (After Catch)", score: 70, grade: "Developing" },
      { skill: "Blocking", score: 55, grade: "Needs Work" },
      { skill: "Route Depth", score: 92, grade: "Elite" },
      { skill: "Hand-Eye Coord", score: 88, grade: "Excellent" },
    ]);
