      ...
      <div class="hero-container">
        <div class="hero-content">
          ...
          <div class="hero-actions">
            <p-button label="Get Started Free" icon="pi pi-arrow-right" 
                      [routerLink]="['/register']" styleClass="p-button-lg"></p-button>
            <p-button label="Sign In" icon="pi pi-sign-in" 
                      [routerLink]="['/login']" [outlined]="true" styleClass="p-button-lg"></p-button>
          </div>
      ...
      <div class="features-container">
        <div class="features-header">
          ...
          <p class="features-subtitle">
            Powerful tools designed to help you train smarter, compete better, and grow faster
          </p>
        </div>
  ...
  features = [
    {
      ...
      description: 'Track every training session and game statistic. Get insights that help you identify strengths and areas for improvement.',
      icon: 'pi-chart-bar'
    },
    {
      id: 'tournament',
      title: 'Tournament System',
      description: 'Join competitive tournaments, climb leaderboards, and compete against the best players in your region.',
      icon: 'pi-trophy'
    },
    {
      id: 'community',
      title: 'Community Hub',
      description: 'Connect with players, coaches, and teams. Share strategies, celebrate wins, and build lasting relationships.',
      icon: 'pi-users'
    },
    {
      id: 'training',
      title: 'Training Programs',
      description: 'Access structured workouts and skill development plans designed by professional coaches and trainers.',
      icon: 'pi-bolt'
    }
  ];
}
