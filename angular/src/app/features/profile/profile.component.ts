        ...
        <div class="profile-header">
          <div class="profile-avatar-section">
            <p-avatar [label]="userInitials()" size="xlarge" shape="circle" 
                     [style]="{'background-color': '#089949', 'color': '#fff', 'font-size': '3rem'}">
            </p-avatar>
            <p-button icon="pi pi-camera" [rounded]="true" [text]="true" 
                     styleClass="avatar-edit-btn" ariaLabel="Change profile picture"></p-button>
          </div>
          ...
          <div class="profile-actions">
            <p-button label="Edit Profile" icon="pi pi-cog" [outlined]="true" 
...
export class ProfileComponent implements OnInit {
  ...
  loadProfileData(): void {
    ...
    this.performanceStats.set([
      { label: 'Overall Performance', value: '85%', trend: '+5%', trendType: 'success' },
