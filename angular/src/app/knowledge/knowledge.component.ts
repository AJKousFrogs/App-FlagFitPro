  ...
  styles: [
    `
      ...
      .search input { flex: 1; background: var(--surface-2); border: 1px solid var(--border-soft);
        border-radius: var(--r-pill); padding: 11px 14px; color: var(--text-strong); font-family: var(--font-body); }
      ...
      .entry p { margin: 0; color: var(--text-muted); font-size: var(--fs-sm); line-height: 1.5; }
      .ev { font-size: var(--fs-xs); font-weight: var(--fw-bold); padding: 2px 7px; border-radius: var(--r-pill);
