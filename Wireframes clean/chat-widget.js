...
class ChatWidget {
  ...
  addMessage(text, sender) {
    ...
    this.announceToScreenReader(
      `${sender === "user" ? "You said" : "AI Coach said"}: ${text}`,
    );
  }
  ...
  getAIResponses(userMessage) {
    ...
    if (
      ...
      userMessage.includes("recovery") ||
      userMessage.includes("rest") ||
      userMessage.includes("sleep")
    ) {
  ...
  addWelcomeMessage() {
    setTimeout(() => {
      this.addMessage(
        "Hey there! I'm your AI Coach. I'm here to help with training, nutrition, recovery, and anything else you need. How can I assist you today?",
        "assistant",
      );
    }, 1000);
  }
