          ...
          rows: [
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("2024 Baseline")],
                  width: { size: 30, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
                new TableCell({
                  children: [new Paragraph("Growth Rate")],
                  width: { size: 30, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
              ],
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [
                    new Paragraph("Total U.S. Flag Football Participants"),
                  ],
                }),
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("Youth Flag Football (6–17 yrs)")],
                }),
                new TableCell({
                  children: [new Paragraph("2.4M (organized programs)")],
                }),
                new TableCell({
                  children: [new Paragraph("14% (2019–2024 CAGR)")],
                }),
              ],
            }),
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("High School Girls Flag Football")],
                }),
                new TableCell({
                  children: [new Paragraph("68.8K (2024–25 season)")],
                }),
                new TableCell({
                  children: [new Paragraph("60% YoY (2023–25)")],
                }),
              ],
            }),
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("Professional League Funding")],
                }),
                new TableCell({
                  children: [new Paragraph("$32M NFL investment (Dec 2025)")],
                }),
                new TableCell({
                  children: [
                    new Paragraph("Men's + women's leagues launching"),
                  ],
                }),
              ],
            }),
        ...
        new Table({
          ...
          rows: [
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("Competitor")],
                ...
                new TableCell({
                  children: [new Paragraph("Pricing Model")],
                ...
                new TableCell({
                  children: [new Paragraph("Weakness")],
                  width: { size: 25, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Consumer / Individual")],
                }),
                new TableCell({ children: [new Paragraph("$80/yr")] }),
                new TableCell({
                  children: [new Paragraph("Large user base; social features")],
                }),
                new TableCell({
                  children: [
                    new Paragraph("No team/coach features; running-focused"),
                  ],
                }),
              ],
            }),
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Consumer Wearable")],
                }),
                new TableCell({ children: [new Paragraph("$199–359/yr")] }),
                new TableCell({
                  children: [
                    new Paragraph("Injury prevention focus; HRV data"),
                  ],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "Hardware-dependent; no sport-specific features",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Marketplace programs; strong UI")],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "Strength-training focus; not sport-agnostic",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("Catapult / Kinduct")],
                }),
                new TableCell({
                  children: [new Paragraph("Enterprise (Pro & College)")],
                }),
                new TableCell({ children: [new Paragraph("$50K–250K+/yr")] }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "Comprehensive wearable integration; market leader",
                    ),
                  ],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "Expensive; complex; overkill for recreational",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Enterprise (Pro teams)")],
                }),
                new TableCell({
                  children: [new Paragraph("Custom / $50K–150K+/yr")],
                }),
                new TableCell({
                  children: [new Paragraph("AI/ML-driven predictive models")],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "Enterprise-only; not accessible to recreational",
                    ),
                  ],
                }),
              ],
          ...
          rows: [
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Features")],
                  width: { size: 40, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Small teams (8–12)")],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "Manual workload logging, injury tracking, team dashboard",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Competitive leagues (12–30)")],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "All Starter + wearable integration, ACWR alerts, analytics",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("High-performance (30+)")],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "All Pro + multi-team, ML models, custom reports, API access",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("$2,499–4,999/season")],
                }),
                new TableCell({
                  children: [new Paragraph("League operators (100+)")],
                }),
                new TableCell({
                  children: [
                    new Paragraph(
                      "All features + league benchmarking, draft insights, rev share",
                    ),
                  ],
                }),
              ],
          ...
          rows: [
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Price Point")],
                  width: { size: 20, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
                new TableCell({
                  children: [new Paragraph("FlagFit Positioning")],
                  width: { size: 40, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [
                    new Paragraph(
                      "Pro tier ($399) targets teams; 3× higher value",
                    ),
                  ],
                }),
              ],
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [
                    new Paragraph("$399 Pro is comparable entry point"),
                  ],
                }),
              ],
            }),
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [
                    new Paragraph("League tier ($2.5K) is 10× cheaper"),
                  ],
                }),
              ],
            }),
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [
                    new Paragraph("Individual Premium ($24.99/mo) parity"),
                  ],
                }),
              ],
            }),
          ...
          rows: [
            new TableRow({
              children: [
                ...
                new TableCell({
                  children: [new Paragraph("Year 1")],
                  width: { size: 20, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
                new TableCell({
                  children: [new Paragraph("Year 2")],
                  width: { size: 20, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
                new TableCell({
                  children: [new Paragraph("Year 3")],
                  width: { size: 20, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
                new TableCell({
                  children: [new Paragraph("CAGR")],
                  width: { size: 20, type: WidthType.PERCENTAGE },
                  shading: { type: "clear", color: "E8E8E8" },
                }),
              ],
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("Total ARR")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("$91.6K")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("$449K")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("$3.37M")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("191%")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
              ],
            }),
            ...
            new TableRow({
              children: [
                new TableCell({
                  children: [new Paragraph("Gross Profit")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("$73.3K")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("$359K")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
                  children: [new Paragraph("$2.70M")],
                  shading: { type: "clear", color: "F0F0F0" },
                }),
                new TableCell({
...
const outputPath =
  ...
  "/Users/aljosaursakous/Desktop/Flag football HTML - APP/FlagFit-Pro-Business-Development-Plan.docx";
