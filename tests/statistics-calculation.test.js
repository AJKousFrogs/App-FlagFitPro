...
describe("StatisticsCalculationService - JavaScript", () => {
  describe("Completion Percentage", () => {
    it("should calculate standard completion percentage", () => {
      const result = statisticsCalculationService.calculateCompletionPercentage(
        10,
        20,
      );
    ...
    it("should throw on negative values", () => {
      expect(() =>
        statisticsCalculationService.calculateCompletionPercentage(-1, 10),
      ).toThrow("Stats cannot be negative");
    });

    it("should throw when completions exceed attempts", () => {
      expect(() =>
        statisticsCalculationService.calculateCompletionPercentage(20, 10),
  ...
  describe("Flag Pull Success Rate with Confidence", () => {
    it("should calculate with 95% confidence interval", () => {
      const result = statisticsCalculationService.calculateFlagPullSuccessRate(
        45,
        50,
      );
    ...
    it("should return correct defensive grade", () => {
      const elite = statisticsCalculationService.calculateFlagPullSuccessRate(
        90,
        100,
      );
      const poor = statisticsCalculationService.calculateFlagPullSuccessRate(
        50,
        100,
      );
