...
describe('API Integration Tests', () => {
  ...
  describe('Training Data Flow', () => {
    it('should save and retrieve training session', async () => {
      ...
      const saveResult = await apiConfig.makeRequest('/api/training', 'POST', trainingData)
  ...
  describe('Nutrition Tracking Flow', () => {
    it('should log and analyze nutrition data', async () => {
        ...
        meals: [
          {
            ...
            foods: [
              ...
              { name: 'Banana', calories: 100, protein: 1, carbs: 25, fat: 0.5 }
            ]
          }
        ]
      }
      ...
      const result = await apiConfig.makeRequest('/api/nutrition', 'POST', nutritionData)
  ...
  describe('Real-time Performance Updates', () => {
    it('should handle live performance data', async () => {
      ...
      const result = await apiConfig.makeRequest('/api/performance/live', 'POST', performanceData)
  ...
  describe('Error Recovery', () => {
    ...
    it('should handle server errors with fallback', async () => {
      ...
      await expect(apiConfig.makeRequest('/api/critical-data', 'GET'))
  ...
  describe('Data Synchronization', () => {
    it('should sync offline data when connection restored', async () => {
      ...
      const result = await apiConfig.makeRequest('/api/sync', 'POST', { data: offlineData })
