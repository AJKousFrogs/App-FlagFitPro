...
describe("Error Handler - Comprehensive Tests", () => {
  ...
  describe("Error Logging", () => {
    ...
    it("should sanitize sensitive information from error logs", () => {
      ...
      errorHandler.sanitizeError.mockImplementation((_error) => {
  ...
  describe("API Error Handling", () => {
    ...
    it("should handle 401 Unauthorized errors", () => {
      ...
      errorHandler.handleAuthError.mockImplementation((_error) => {
        return {
          type: "auth_error",
    ...
    it("should handle 403 Forbidden errors", () => {
      ...
      errorHandler.handleApiError.mockImplementation((_error) => {
        return {
    ...
    it("should handle 500 Server errors", () => {
      ...
      errorHandler.handleServerError.mockImplementation((_error) => {
        return {
          type: "server_error",
          userMessage:
  ...
  describe("Network Error Handling", () => {
    it("should handle network timeout errors", () => {
      ...
      errorHandler.handleNetworkError.mockImplementation((_error) => {
        return {
  ...
  describe("Error Recovery", () => {
    ...
    it("should suggest recovery actions", () => {
      ...
      errorHandler.suggestRecovery = vi.fn().mockImplementation((_error) => {
        return {
          actions: ["check_internet_connection", "retry_save", "save_locally"],
          autoRetry: true,
          retryDelay: 5000,
        };
      });
    ...
    it("should handle graceful degradation", () => {
      ...
      errorHandler.handleGracefulDegradation = vi
        .fn()
        .mockImplementation((_error) => {
          return {
            fallbackMode: "basic_coaching",
            userMessage:
              "AI coaching is temporarily unavailable. Using basic coaching mode.",
            affectedFeatures: [
  ...
  describe("Error Reporting & Telemetry", () => {
    ...
    it("should aggregate error patterns", () => {
      ...
      errorHandler.aggregateErrorPatterns = vi
        .fn()
  ...
  describe("Error Context Enhancement", () => {
    it("should enhance errors with user context", () => {
      ...
      errorHandler.enhanceWithContext = vi
        .fn()
      ...
      const enhancedError = errorHandler.enhanceWithContext(
        baseError,
        userContext,
      );
    ...
    it("should track error frequency per user", () => {
      ...
      errorHandler.trackUserErrorFrequency = vi
        .fn()
        .mockImplementation((_userId, _error) => {
          return {
            errorCount: 5,
      ...
      const tracking = errorHandler.trackUserErrorFrequency(
        userId,
        new Error("test"),
      );
