...
--primitive-font-display: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', sans-serif;
```
...
*Report generated by analyzing DESIGN_SYSTEM_DOCUMENTATION.md against actual implementation files.*
