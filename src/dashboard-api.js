...
class DashboardAPI {
  ...
  async getDashboardOverview() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/overview?userId=${this.userId}`,
      );
  ...
  async getTrainingCalendar() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/training-calendar?userId=${this.userId}`,
      );
      this.setCachedData(cacheKey, data);
      return data;
    } catch (error) {
  ...
  async getOlympicQualification() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/olympic-qualification?userId=${this.userId}`,
      );
      this.setCachedData(cacheKey, data);
      return data;
    } catch (error) {
  ...
  async getSponsorRewards() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/sponsor-rewards?userId=${this.userId}`,
      );
      this.setCachedData(cacheKey, data);
      return data;
    } catch (error) {
  ...
  async getWearables() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/wearables?userId=${this.userId}`,
      );
      this.setCachedData(cacheKey, data);
      return data;
    } catch (error) {
  ...
  async getTeamChemistry() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/team-chemistry?userId=${this.userId}`,
      );
      this.setCachedData(cacheKey, data);
      return data;
    } catch (error) {
  ...
  async getNotifications() {
    ...
    try {
      const data = await this.apiCall(
        `/dashboard/notifications?userId=${this.userId}`,
      );
      this.setCachedData(cacheKey, data);
      return data;
    } catch (error) {
  ...
  getFallbackOverview() {
    return {
      ...
      data: {
        ...
        nextSession: {
          type: "Olympic preparation training",
          time: "4:00 PM",
          duration: 120,
        },
      },
