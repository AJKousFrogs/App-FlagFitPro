    ...
    week1: {
      ...
      days: {
        monday: {
          ...
          blocks: [
            {
              ...
              exercises: [
                ...
                },
                {
                  ...
                  reps: "AMRAP",
                  rest: "2 min",
                  notes: "Use resistance band for assistance. Control descent for 3-5 seconds. Even 1-2 reps is progress"
                },
                {
                  name: "Hip Thrusts",
                  sets: 3,
          ...
          equipment: ["Barbell/dumbbells (15-25 lbs)", "resistance bands", "elevated surface"]
        },
        tuesday: {
        ...
        friday: {
              ...
              exercises: [
                {
                  ...
                  variations: [
                    ...
                    { name: "Lateral shuffle", sets: 3, duration: "20s each direction" },
          ...
          equipment: ["Box", "medicine ball (8-12 lbs)", "agility ladder", "cones", "bands"]
        },
        saturday: {
          title: "Sprint Work",
          type: "sprint",
                ...
                exercises: [
                  {
                    ...
                    intensity: "75%",
                    rest: "2 min",
                    notes: "Focus on first 10 yards (drive phase). Cue: Push the ground away"
                  },
                  {
                    name: "Build-Up Runs",
                    sets: 4,
          ...
          equipment: ["Wall space", "resistance bands", "mini hurdles (optional)"]
        },
        sunday: {
          title: "Recovery Day",
          type: "recovery",
  ...
  dailyFramework: {
    trainingDays: {
      breakfast: {
        ...
        components: ["Complex carbs: Oatmeal, rice, sweet potato", "Protein: Eggs, Greek yogurt", "Fats: Nuts, avocado"],
        example: "3 eggs + oatmeal with berries + almond butter"
      },
      preTraining: {
        timing: "30-60 min before",
        components: ["Simple carbs: Banana, rice cakes", "Light protein: Protein shake"],
      ...
      postTraining: {
        ...
        components: ["Fast-acting protein: Whey shake", "Simple carbs: Fruit, honey"],
        example: "Protein shake + banana"
      },
      lunch: {
        timing: "2-3 hours post-training",
        components: ["Lean protein: Chicken, fish, lean beef", "Complex carbs: Rice, quinoa, pasta", "Vegetables: Variety of colors"],
        example: "Grilled chicken + brown rice + broccoli"
      },
      dinner: {
        components: ["Lean protein", "Complex carbs (adjust based on next day)", "Vegetables", "Healthy fats"]
      },
      beforeBed: {
    ...
    restDays: {
      adjustments: ["Slightly reduce carbs", "Maintain protein intake", "Increase healthy fats", "Focus on recovery foods"]
    }
  },
