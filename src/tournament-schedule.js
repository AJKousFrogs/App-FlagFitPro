...
export const getAllTournaments = () => {
  return [
    ...TOURNAMENT_SCHEDULE['2026'],
    ...TOURNAMENT_SCHEDULE['2027']
  ];
};
...
export const getTournamentPreparation = (tournament) => {
  if (tournament.startDate === 'TBD') {
    return {
      ...
      tasks: ['Stay tuned for official announcement', 'Prepare training schedule', 'Monitor registration updates']
    };
  }
  ...
  if (daysUntil > 90) {
    return {
      ...
      tasks: ['Focus on basic skills', 'Build team chemistry', 'Develop strategy']
    };
  } else if (daysUntil > 30) {
    return {
      phase: 'intensive_training',
      description: 'Intensive training phase',
      tasks: ['Advanced drills', 'Tactical preparation', 'Physical conditioning']
    };
  } else if (daysUntil > 7) {
    return {
