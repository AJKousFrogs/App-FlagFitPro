...
export class SecureStorage {
    ...
    getOrCreateKey() {
        ...
        const sessionId = sessionStorage.getItem('secureStorageKey') || this.generateSessionId();
    ...
    setUserData(userData) {
        ...
        try {
            ...
            const encryptedUserData = this.simpleEncrypt(userDataString, this.encryptionKey);
            ...
            if (this.supportsCookies()) {
                ...
                const encryptedEssentialData = this.simpleEncrypt(essentialDataString, this.encryptionKey);
    ...
    getUserData() {
        try {
            ...
            if (encryptedUserData) {
                const userDataString = this.simpleDecrypt(encryptedUserData, this.encryptionKey);
    ...
    verifyTokenHash(token) {
        try {
            ...
            const expectedHash = btoa(token).split('').reverse().join('').substring(0, 16);
