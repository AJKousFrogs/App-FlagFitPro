  ...
  supplements: [
    {
      ...
      notes: 'Ensures muscle function, recovery, and sleep. Consistency is key.',
    ...
    },
    {
      ...
      notes: 'Better absorption with dietary fat. Supports anti-inflammation & recovery.',
    ...
    },
    {
      ...
      notes: 'Supports recovery, avoid mega doses. Split into 2–3 smaller doses per day.',
    ...
    },
    {
      ...
      notes: 'Better absorbed away from coffee/tea/calcium. Avoid 6h post-exercise peak.',
...
export const PERFORMANCE_TESTS = {
  ...
  anthropometric: {
    ...
    bodyFat: {
      name: 'Body Fat %',
      unit: '%',
      target: { male: { elite: 8, good: 12, average: 15 }, female: { elite: 15, good: 18, average: 22 } },
      frequency: 'Monthly',
