...
class YouTubeTrainingService {
  ...
  filterAndSortVideos(videos, maxResults) {
    ...
    return scoredVideos.sort((a, b) => b.score - a.score).slice(0, maxResults);
  }
      ...
      "warm-up": [
        {
          ...
          description:
            "Complete warm-up routine including A skips, B skips, and C skips for sprint preparation.",
        ...
        },
        {
          ...
          description:
            "Professional warm-up sequence for flag football and sprint training.",
      ...
      agility: [
        {
          ...
          description:
            "Change of direction and cutting drills for flag football.",
