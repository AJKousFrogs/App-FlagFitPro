...
(function() {
  ...
  function highlightActiveNav() {
    ...
    const allNavItems = document.querySelectorAll('.nav-item, .sidebar-link, [class*="nav-"]');
    ...
    if (activeNav) {
      ...
      while (parent && parent !== document.body) {
        if (parent.classList.contains('nav-item') || parent.classList.contains('sidebar-link')) {
    ...
    if (!activeNav) {
      const navLinks = document.querySelectorAll('a.nav-item, a.sidebar-link, a[href*="' + currentPage + '"]');
