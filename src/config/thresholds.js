...
export const WEATHER_IMPACT_RULES = {
  temperature: [
    {
      ...
      impacts: {
        ...
        injuryRisk: "High",
        recommendations: [
          "Extra hydration every 15 minutes",
    ...
    },
    {
      ...
      impacts: {
        running: -10,
        recommendations: [
          "Warm up for 20 minutes minimum",
  ...
  wind: [
    {
      ...
      impacts: {
        passing: -20,
        recommendations: [
          "Adjust passing strategy for wind",
          "Focus on running plays",
        ],
      },
    },
    {
  ...
  riskFactors: [
    ...
    {
      condition: (conditions) => conditions.includes("thunderstorm"),
      score: 3,
    },
...
export const CALORIE_MATCH_RATINGS = [
  ...
  {
    threshold: Infinity,
    rating: "Adjust portions as needed",
    color: "#ef4444",
  },
];
