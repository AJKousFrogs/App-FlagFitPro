class FilterManager {
  ...
  getFilterGroup(container) {
    if (container.classList.contains("wireframe-grid")) {
      return "grid";
    }
    if (container.classList.contains("wireframe-card")) {
      return "card";
    }
  ...
  findContentArea(container) {
    return (
      container.querySelector(".wireframe-grid") ||
  ...
  setupKeyboardNavigation() {
    ...
    this.keyboardHandler = (e) => {
      ...
      if (e.key === "ArrowRight" || e.key === "ArrowLeft") {
        ...
        if (
          activeElement &&
          activeElement.classList.contains("cta-secondary")
        ) {
