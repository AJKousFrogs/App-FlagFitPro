/**
 * Supabase Client Utility (CommonJS)
 * Reusable Supabase client for Node.js and server-side contexts
 * 
 * Usage:
 *   const { getSupabaseClient, getSupabaseAdmin } = require('./utils/supabase-client.cjs');
 *   
...
// Export default client (anon key) for convenience
module.exports.default = getSupabaseClient();
