...
export function initSidebarToggle() {
  const sidebarOverlays = document.querySelectorAll('[data-sidebar-overlay], .sidebar-overlay');
...
export function initNavigationHandlers() {
  ...
  document.querySelectorAll('[data-action="decline"], [data-action="back"]').forEach(button => {
    button.addEventListener('click', (e) => {
      e.preventDefault();
...
export function initButtonActionHandlers() {
  ...
  document.querySelectorAll('[data-action]').forEach(button => {
    ...
    switch(action) {
      ...
      case 'show-profile-modal':
        button.addEventListener('click', (e) => {
          e.preventDefault();
          if (window.profileCompletionManager && window.profileCompletionManager.showProfileCompletionModal) {
  ...
  document.querySelectorAll('[data-role], .team-option[data-navigate-to], .team-option[data-action], .role-card[data-action]').forEach(element => {
...
export function initFormHandlers() {
  ...
  document.querySelectorAll('[data-action="update-charts"]').forEach(element => {
