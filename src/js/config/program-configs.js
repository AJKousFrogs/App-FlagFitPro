...
export const OFFSEASON_PROGRAM_CONFIG = {
  ...
  description:
    "Evidence-based 14-week periodized program for flag football WR/DB players. Build sprint speed, explosive power, posterior chain strength, and game-specific conditioning for 40+ sprints per game.",
  role: "WR/DB",
...
export const QB_PROGRAM_CONFIG = {
  ...
  description:
    "Comprehensive quarterback development program preparing you for the ultimate challenge: 320 throws in a weekend tournament while maintaining velocity and accuracy. Dual-track training combines lower body power with QB-specific arm development.",
  role: "QB",
  ...
  challenge: {
    ...
    days: 2,
    description:
      "This requires EXTREME preparation - sustained accuracy under fatigue",
    demands: [
  ...
  assessments: [
    {
      ...
      type: "velocity-mobility-endurance",
      throws: 100,
    },
    {
      week: 7,
      name: "Mid-Strength Assessment",
      type: "power-velocity",
      throws: 150,
    },
    {
      week: 11,
      name: "Power Peak Assessment",
      type: "comprehensive-endurance",
      throws: 200,
    },
    {
      week: 13,
