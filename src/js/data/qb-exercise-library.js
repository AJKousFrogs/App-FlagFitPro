...
export const QB_EXERCISE_LIBRARY = {
    ...
    "Band External Rotation": {
        ...
        importance: "CRITICAL - Rotator cuff strength correlates with velocity (r=0.72)",
    ...
    "Sleeper Stretch": {
        ...
        difficulty: "Beginner",
        equipment: ["None"],
        importance: "MANDATORY post-throwing - prevents posterior shoulder tightness",
    ...
    "Kneeling Hip Flexor Stretch": {
        ...
        evidence: "Hip flexor flexibility increases stride length 8-12% (AJSM, 2020)"
    },
    ...
    "Thoracic Extensions": {
        ...
        evidence: "Thoracic extension adds 8-12 mph velocity (J Strength Cond, 2021)"
    },
    ...
    "Long Toss": {
        ...
        protocol: {
            progression: [
                ...
                { distance: "Work back in", throws: "5-10", intensity: "Gradually decrease" }
            ],
            totalThrows: "30-50",
