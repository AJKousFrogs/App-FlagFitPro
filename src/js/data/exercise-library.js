...
export const EXERCISE_LIBRARY = {
        ...
        variations: [
            {
                ...
                rest: "2-3 min",
                coaching: ["Max distance per bound", "Powerful push-off", "Stick landing"],
        ...
        variations: [
            {
                ...
                sets: "4-6",
                reps: "6-10 hurdles",
                coaching: ["Continuous rhythm", "Minimize ground time", "Soft landings"]
            },
            {
    ...
    "Isometric Squat Holds": {
        ...
        protocol: {
            positions: [
                { name: "Quarter squat", angle: "140-150°", purpose: "Max force production" },
                { name: "Parallel squat", angle: "90°", purpose: "Sport-specific strength" },
                { name: "Deep squat", angle: "60-70°", purpose: "Bottom position strength" }
            ],
    ...
    "Couch Stretch": {
        ...
        qbImportance: "NON-NEGOTIABLE for QB velocity - tight hip flexors reduce velocity 15-20%"
    },
    ...
    "Foam Rolling": {
        ...
        protocol: {
            areas: [
                { muscle: "Calves", duration: "60-90s each", technique: "Slow rolls + holds" },
                { muscle: "Hamstrings", duration: "90s each", technique: "Slow rolls" },
                { muscle: "Quads", duration: "90-120s each", technique: "Find trigger points" },
                { muscle: "Hip flexors", duration: "60s each", technique: "Gentle pressure" },
                { muscle: "Glutes", duration: "60-90s each", technique: "Cross leg for depth" },
    ...
    "Dynamic Stretching": {
        ...
        exercises: [
            ...
            },
            {
                ...
                reps: "10 each leg",
                coaching: ["Lunge + rotate toward front leg", "Hip mobility + rotation"]
            },
            {
                name: "Inchworms",
                reps: "8-10",
                coaching: ["Walk hands out to plank", "Walk feet to hands", "Full body"]
            },
            {
                name: "World's Greatest Stretch",
                reps: "5 each side",
                coaching: ["Lunge + elbow to instep + rotate + reach", "Multiple planes"]
            }
        ],
    ...
    "Pro Agility Drill": {
        ...
        protocol: {
            setup: "3 cones, 5 yards apart",
            execution: "Sprint 5y right, touch, sprint 10y left, touch, sprint 5y right through finish",
    ...
    "L-Drill (3-Cone)": {
        ...
        protocol: {
            ...
            execution: "Sprint to cone 1, back to start, to cone 1, around cone 2, around cone 3, finish",
            assessment: "Timed test"
        },
