...
export const QB_ENHANCED_WARMUP = {
    ...
    description: "Comprehensive QB warm-up emphasizing shoulder health and throwing chain",
    duration: 30,
    ...
    phases: [
        {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    cues: ["Start small", "Gradually increase", "Control movement", "Both directions"]
                },
                {
            ...
            sections: [
                {
                    ...
                    exercises: [
                        ...
                        },
                        {
                            ...
                            cues: ["Arm at 45° angle", "Raise to shoulder height", "Control descent"]
                        },
                        {
                ...
                },
                {
                    ...
                    exercises: [
                        ...
                        },
                        {
                            ...
                            sets: 2,
                            duration: "45s",
                            variations: ["High (above head)", "Mid (shoulder level)", "Low (below shoulder)"],
            ...
            sections: [
                {
                    ...
                    exercises: [
                        ...
                        },
                        {
                            ...
                            execution: ["Arch back (cow)", "Round back (cat)", "Slow and controlled"],
...
export const PROGRESSIVE_THROWING_WARMUP = {
    ...
    protocol: [
        ...
        },
        {
            ...
            cues: ["Game-ready throws", "Maximum velocity with control", "Arm is warm"]
        }
    ],
